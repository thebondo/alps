...
function scrollRectIntoView(view, rect, startDOM) {
	...
	for (let parent = startDOM || view.dom;;) {
		...
		let moveX = 0, moveY = 0;
		if (rect.top < bounding.top + getSide$1(scrollThreshold, "top")) moveY = -(bounding.top - rect.top + getSide$1(scrollMargin, "top"));
...
function keyName(event) {
	var name = !(mac$1 && event.metaKey && event.shiftKey && !event.ctrlKey && !event.altKey || ie && event.shiftKey && event.key && event.key.length == 1 || event.key == "Unidentified") && event.key || (event.shiftKey ? shift$2 : base)[event.keyCode] || event.key || "Unidentified";
...
var index_default$1 = Extension.create({
	name: "starterKit",
	addExtensions() {
		var _a, _b, _c, _d;
		const extensions = [];
...
//#endregion
export { index_default$1 as a, getMarkRange as c, index_default as i, Color as n, Editor as o, TextStyle as r, Extension as s, BubbleMenu as t };
