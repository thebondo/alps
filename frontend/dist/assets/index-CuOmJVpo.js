...
`,pt=class extends d{constructor(...e){super(...e),this.title=``,this.isDanger=!1,this.dismissible=!1,this.width=`400px`,this._handleDialogClose=()=>{this.dispatchEvent(new CustomEvent(`cancel`,{bubbles:!0,composed:!0}))}}static{this.styles=n`
  ...
  `}handleInput(e){let t=e.target;this.value=t.value,this.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}togglePassword(){this.showPassword=!this.showPassword}handleClear(){this.value=``,this.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`clear`,{bubbles:!0,composed:!0}))}handleKeyDown(e){if(e.key===`Enter`){let t=this.closest(`form`);t&&(e.preventDefault(),t.requestSubmit())}}checkValidity(){let e=this.shadowRoot?.querySelector(`input`);return e?e.checkValidity():!0}reportValidity(){let e=this.shadowRoot?.querySelector(`input`);return e?e.reportValidity():!0}focus(){let e=this.shadowRoot?.querySelector(`input`);e&&e.focus()}render(){let e=this.type===`password`,t=e&&this.showPassword?`text`:this.type,n=this.icon||(this.type===`email`?`at`:``);return s`
    ...
    `}getMonthGrid(){let e=new Date(this.year,this.month,1),t=new Date(this.year,this.month+1,0),n=[],r=new Date(e),i=r.getDay();for(i===0&&(i=7),r.setDate(r.getDate()-(i-1));r<=t||n.length%7!=0;)n.push(new Date(r)),r.setDate(r.getDate()+1);return n}hasEventsForDate(e){if(!this.events||this.events.length===0)return!1;let t=new Date(e);t.setHours(0,0,0,0);let n=new Date(e);return n.setHours(23,59,59,999),this.events.some(e=>{if(Fe(e.start,e.end)){let n=e.start.split(`T`)[0],r=e.end.split(`T`)[0],i=new Date(n+`T00:00:00`),a=new Date(r+`T00:00:00`);return i<=t&&a>t}else{let r=new Date(e.start),i=new Date(e.end);return i.getTime()===t.getTime()&&r.getTime()<i.getTime()?!1:r<=n&&i>=t}})}handleDateClick(e){this.dispatchEvent(new CustomEvent(`date-selected`,{detail:{date:e},bubbles:!0,composed:!0}))}render(){let e=this.getMonthGrid(),t=Array.from({length:7},(e,t)=>{let n=new Date(2021,10,t+1);return this.i18nStore?.t(`calendar.daysNarrow.${n.getDay()}`)}),n=new Date;n.setHours(0,0,0,0);let r=this.i18nStore?.t(`calendar.months.${this.month}`);return s`
        ...
        `}};k([g({context:w})],ht.prototype,`i18nStore`,void 0),k([o({type:Number})],ht.prototype,`year`,void 0),k([o({type:Number})],ht.prototype,`month`,void 0),k([o({type:Array})],ht.prototype,`events`,void 0),k([o({type:Boolean})],ht.prototype,`showTitle`,void 0),k([o({type:Object})],ht.prototype,`currentDate`,void 0),ht=k([m(`calendar-mini-month`)],ht);var gt=n`
  .dropdown-header {
...
`,_t=class extends d{constructor(...e){super(...e),this.align=`right`,this.position=`bottom`,this.triggerOn=`click`,this.openState=!1,this._handleDialogClick=e=>{this.openState&&e.target===e.currentTarget&&(e.stopPropagation(),e.preventDefault(),this.close())},this._handleDialogClose=()=>{this.openState&&this.close()},this._handleDialogKeydown=e=>{if(this.openState){if(e.key===`ArrowDown`||e.key===`ArrowUp`){e.preventDefault();let t=this._getFocusableElements();if(t.length===0)return;let n=this._getActiveElement(),r=t.findIndex(e=>e===n);r=e.key===`ArrowDown`?r===-1?0:(r+1)%t.length:r===-1?t.length-1:(r-1+t.length)%t.length,t[r].focus()}else if(e.key===`Enter`||e.key===` `){let t=this._getActiveElement();t&&typeof t.click==`function`&&(e.preventDefault(),t.click())}}},this._closeTimeout=null,this._handleMouseEnter=()=>{this.triggerOn===`hover`&&(this._closeTimeout&&=(clearTimeout(this._closeTimeout),null),this.open())},this._handleMouseLeave=()=>{this.triggerOn===`hover`&&(this._closeTimeout&&clearTimeout(this._closeTimeout),this._closeTimeout=setTimeout(()=>{this.close(),this._closeTimeout=null},300))},this._handleResize=()=>{this.openState&&this._updatePosition()}}static{this.styles=n`
  ...
  `}open(){this.openState=!0,this.dispatchEvent(new CustomEvent(`popup-open`,{bubbles:!0,composed:!0}))}close(){this.openState=!1,this.dispatchEvent(new CustomEvent(`popup-close`,{bubbles:!0,composed:!0}))}toggle(e){if(this.triggerOn===`hover`){e.stopPropagation();return}this.openState?this.close():this.open()}_getActiveElement(){let e=document.activeElement;for(;e?.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}_getFocusableElements(){let e=this.shadowRoot?.querySelector(`slot:not([name])`);if(!e)return[];let t=e.assignedElements({flatten:!0}),n=[],r=`button:not([disabled]), a[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])`;return t.forEach(e=>{if(e instanceof HTMLElement){e.matches(r)&&n.push(e);let t=Array.from(e.querySelectorAll(r));n.push(...t)}}),n}updated(e){if(super.updated(e),e.has(`openState`)){let e=this.shadowRoot?.querySelector(`.popup-dialog`);if(this.openState)e&&!e.open&&(this.triggerOn===`hover`?e.show():e.showModal()),this._updatePosition();else if(e&&e.open){e.close();let t=this.shadowRoot?.querySelector(`slot[name="trigger"]`);t&&t.assignedElements({flatten:!0}).forEach(e=>{e instanceof HTMLElement&&e.blur()})}}}_updatePosition(){let e=this.shadowRoot?.querySelector(`.trigger`),t=this.shadowRoot?.querySelector(`.popup-content`);if(!e||!t)return;let n=e.getBoundingClientRect(),r=t.getBoundingClientRect(),i=this.position,a=this.align;if(t.style.top=``,t.style.bottom=``,t.style.left=``,t.style.right=``,t.style.removeProperty(`--arrow-right`),t.style.removeProperty(`--arrow-left`),t.style.removeProperty(`--arrow-top`),t.style.removeProperty(`--arrow-bottom`),this.position===`left`||this.position===`right`){this.position===`right`?n.right+6+r.width>window.innerWidth&&n.left-6-r.width>=0&&(i=`left`):n.left-6-r.width<0&&n.right+6+r.width<=window.innerWidth&&(i=`right`),this.align===`top`?n.top+r.height>window.innerHeight&&n.bottom-r.height>=0&&(a=`bottom`):n.bottom-r.height<0&&n.top+r.height<=window.innerHeight&&(a=`top`),i===`right`?(t.style.left=`${n.right+6}px`,t.style.right=`auto`):(t.style.right=`${window.innerWidth-n.left+6}px`,t.style.left=`auto`);let e=n.top+n.height/2;if(a===`top`){let i=n.top-4;i+r.height>window.innerHeight&&(i=window.innerHeight-r.height-8),i=Math.max(8,i),t.style.top=`${i}px`,t.style.bottom=`auto`;let a=e-i-6;t.style.setProperty(`--arrow-top`,`${Math.max(10,Math.min(r.height-20,a))}px`)}else{let i=window.innerHeight-n.bottom-4;i+r.height>window.innerHeight&&(i=window.innerHeight-r.height-8),i=Math.max(8,i),t.style.bottom=`${i}px`,t.style.top=`auto`;let a=e-(window.innerHeight-i-r.height)-6;t.style.setProperty(`--arrow-top`,`${Math.max(10,Math.min(r.height-20,a))}px`)}}else if(this.position===`bottom`?n.bottom+8+r.height>window.innerHeight&&n.top-8-r.height>=0&&(i=`top`):n.top-8-r.height<0&&n.bottom+8+r.height<=window.innerHeight&&(i=`bottom`),this.align===`right`?n.right-r.width<0&&n.left+r.width<=window.innerWidth&&(a=`left`):n.left+r.width>window.innerWidth&&n.right-r.width>=0&&(a=`right`),i===`bottom`?(t.style.top=`${n.bottom+8}px`,t.style.bottom=`auto`):(t.style.bottom=`${window.innerHeight-n.top+8}px`,t.style.top=`auto`),a===`right`){let e=window.innerWidth-n.right;e+r.width>window.innerWidth&&(e=window.innerWidth-r.width-8),e=Math.max(8,e),t.style.right=`${e}px`,t.style.left=`auto`;let i=n.left+n.width/2,a=window.innerWidth-e-i-6;t.style.setProperty(`--arrow-right`,`${Math.max(10,Math.min(r.width-20,a))}px`)}else{let e=n.left;e+r.width>window.innerWidth&&(e=window.innerWidth-r.width-8),e=Math.max(8,e),t.style.left=`${e}px`,t.style.right=`auto`;let i=n.left+n.width/2-e-6;t.style.setProperty(`--arrow-left`,`${Math.max(10,Math.min(r.width-20,i))}px`)}t.classList.remove(`position-top`,`position-bottom`,`position-left`,`position-right`,`align-left`,`align-right`,`align-top`,`align-bottom`),t.classList.add(`position-${i}`,`align-${a}`)}connectedCallback(){super.connectedCallback(),window.addEventListener(`resize`,this._handleResize,{passive:!0}),this.addEventListener(`mouseenter`,this._handleMouseEnter),this.addEventListener(`mouseleave`,this._handleMouseLeave)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`resize`,this._handleResize),this.removeEventListener(`mouseenter`,this._handleMouseEnter),this.removeEventListener(`mouseleave`,this._handleMouseLeave),this._closeTimeout&&=(clearTimeout(this._closeTimeout),null)}render(){return s`
    ...
    `}formatEventDate(e,t){let n=Fe(e,t),r;return r=n?new Date(e.split(`T`)[0]+`T00:00:00`):new Date(e),`${this.i18nStore?.t(`calendar.days.${r.getDay()}`)}, ${this.i18nStore?.t(`calendar.monthsShort.${r.getMonth()}`)} ${r.getDate()}, ${r.getFullYear()}`}formatEventTimeRange(e,t){let n=new Date(e),r=new Date(t);if(Fe(e,t))return this.i18nStore?.t(`calendar.allDay`);let i={hour:`numeric`,minute:`2-digit`};return n.toDateString()===r.toDateString()?`${n.toLocaleTimeString(void 0,i)} - ${r.toLocaleTimeString(void 0,i)}`:`${n.toLocaleTimeString(void 0,i)} - ${this.i18nStore?.t(`calendar.monthsShort.${r.getMonth()}`)} ${r.getDate()} ${r.toLocaleTimeString(void 0,i)}`}handleEdit(e){e.stopPropagation();let t=this.closest(`alps-popup`);t&&t.close(),setTimeout(()=>{this.dispatchEvent(new CustomEvent(`edit-event`,{detail:{event:this.event},bubbles:!0,composed:!0}))},10)}handleDelete(e){e.stopPropagation();let t=this.closest(`alps-popup`);t&&t.close(),setTimeout(()=>{this.dispatchEvent(new CustomEvent(`delete-event`,{detail:{event:this.event},bubbles:!0,composed:!0}))},10)}render(){if(!this.event)return s``;let e=this.event;return s`
        ...
        `}};k([g({context:w})],vt.prototype,`i18nStore`,void 0),k([o({type:Object})],vt.prototype,`event`,void 0),vt=k([m(`calendar-event-preview`)],vt);var yt=class extends d{constructor(...e){super(...e),this.days=[],this.events=[],this.scrolled=!1}static{this.styles=n`
        :host {
            display: flex;
            flex-direction: column;
            height: 100%;
    ...
    `}getEventsForDate(e,t){return this.events?this.events.filter(n=>{let r=Fe(n.start,n.end);if(t!==r)return!1;let i=new Date(e);i.setHours(0,0,0,0);let a=new Date(e);if(a.setHours(23,59,59,999),r){let e=n.start.split(`T`)[0],t=n.end.split(`T`)[0],r=new Date(e+`T00:00:00`),a=new Date(t+`T00:00:00`);return r<=i&&a>i}else{let e=new Date(n.start),t=new Date(n.end);return t.getTime()===i.getTime()&&e.getTime()<t.getTime()?!1:e<=a&&t>=i}}):[]}handleColumnClick(e,t){let n=e.currentTarget.getBoundingClientRect(),r=e.clientY-n.top,i=Math.floor(r/48),a=new Date(t);a.setHours(i,0,0,0),this.dispatchEvent(new CustomEvent(`create-event`,{detail:{date:a},bubbles:!0,composed:!0}))}handleAllDayCellClick(e){let t=new Date(e);t.setHours(0,0,0,0),this.dispatchEvent(new CustomEvent(`create-event`,{detail:{date:t},bubbles:!0,composed:!0}))}handleScroll(e){let t=e.target;this.scrolled=t.scrollTop>0}render(){let e=Array.from({length:24},(e,t)=>t),t=new Date;return t.setHours(0,0,0,0),s`
        ...
        `}};k([g({context:w})],yt.prototype,`i18nStore`,void 0),k([o({type:Array})],yt.prototype,`days`,void 0),k([o({type:Array})],yt.prototype,`events`,void 0),k([a()],yt.prototype,`scrolled`,void 0),yt=k([m(`calendar-time-grid`)],yt);var bt=class extends d{constructor(...e){super(...e),this.events=[]}static{this.styles=n`
        :host {
            display: flex;
            height: 100%;
            width: 100%;
    ...
    `}getMonthGrid(){let e=this.date.getFullYear(),t=this.date.getMonth(),n=new Date(e,t,1),r=new Date(e,t+1,0),i=[],a=new Date(n),o=a.getDay();for(o===0&&(o=7),a.setDate(a.getDate()-(o-1));a<=r||i.length%7!=0;)i.push(new Date(a)),a.setDate(a.getDate()+1);return i}getEventsForDate(e,t){return this.events?this.events.filter(n=>{let r=Fe(n.start,n.end);if(t!==r)return!1;let i=new Date(e);i.setHours(0,0,0,0);let a=new Date(e);if(a.setHours(23,59,59,999),r){let e=n.start.split(`T`)[0],t=n.end.split(`T`)[0],r=new Date(e+`T00:00:00`),a=new Date(t+`T00:00:00`);return r<=i&&a>i}else{let e=new Date(n.start),t=new Date(n.end);return t.getTime()===i.getTime()&&e.getTime()<t.getTime()?!1:e<=a&&t>=i}}):[]}handleCellClick(e){this.dispatchEvent(new CustomEvent(`create-event`,{detail:{date:e},bubbles:!0,composed:!0}))}render(){let e=this.getMonthGrid(),t=Array.from({length:7},(e,t)=>{let n=new Date(2021,10,t+1);return this.i18nStore?.t(`calendar.daysShort.${n.getDay()}`)}),n=new Date;return n.setHours(0,0,0,0),s`
                    ...
                    ${e.map(e=>{let t=e.getMonth()!==this.date.getMonth(),r=e.getTime()===n.getTime(),i=this.getEventsForDate(e,!0).concat(this.getEventsForDate(e,!1));return s`
                            <div class="month-cell ${t?`other-month`:``}" @click=${()=>this.handleCellClick(e)} style="cursor: pointer;">
                                ...
                                ${i.slice(0,4).map(e=>s`
                                    <alps-popup align="left" position="bottom" style="width: 100%; display: block;" @click=${e=>e.stopPropagation()}>
                                        <div slot="trigger"
                                            class="event-chip ${Fe(e.start,e.end)?`all-day`:``}" 
                                            style=${e.color?`background-color: ${e.color}`:``}
                                            title="${e.summary||this.i18nStore?.t(`calendar.noTitle`)}">
                                            ${e.summary||this.i18nStore?.t(`calendar.noTitle`)}
                                        </div>
        ...
        `}};k([g({context:w})],St.prototype,`i18nStore`,void 0),k([o({type:Object})],St.prototype,`date`,void 0),k([o({type:Array})],St.prototype,`events`,void 0),St=k([m(`calendar-month-view`)],St);var Ct=class extends d{constructor(...e){super(...e),this.events=[]}static{this.styles=n`
        :host {
            display: flex;
            height: 100%;
            width: 100%;
    ...
    `}render(){return this.events.length===0?s`
        ...
        `}};k([g({context:w})],wt.prototype,`i18nStore`,void 0),k([o({type:Array})],wt.prototype,`events`,void 0),wt=k([m(`calendar-list-view`)],wt);var Tt=class extends d{constructor(...e){super(...e),this.selectedDate=new Date,this.events=[],this.viewDate=new Date}static{this.styles=n`
        :host {
            display: flex;
            flex-direction: column;
            width: 100%;
    ...
    `}updated(e){e.has(`selectedDate`)&&this.selectedDate&&(this.viewDate=new Date(this.selectedDate))}changeMonth(e){let t=new Date(this.viewDate);t.setMonth(t.getMonth()+e),this.viewDate=t}render(){let e=this.viewDate.getFullYear(),t=this.viewDate.getMonth();return s`
        ...
        `}};k([g({context:w})],Tt.prototype,`i18nStore`,void 0),k([o({type:Object})],Tt.prototype,`selectedDate`,void 0),k([o({type:Array})],Tt.prototype,`events`,void 0),k([a()],Tt.prototype,`viewDate`,void 0),Tt=k([m(`alps-sidebar-calendar`)],Tt);var Et=class extends d{constructor(...e){super(...e),this.label=`Today`}static{this.styles=n`
        :host {
            display: inline-flex;
        }
  ...
  `}getInitials(e){if(!e)return`U`;let t=e.trim().split(/[\s.@]+/);return t.length>=2?(t[0][0]+t[1][0]).toUpperCase():e.substring(0,2).toUpperCase()}render(){let e=this.settingsStore?.getState()?.loginUsername||``,t=this.settingsStore?.getState()?.name||``,n=!1;(e&&this.email&&this.email.toLowerCase()===e.toLowerCase()||t&&this.name&&this.name.toLowerCase()===t.toLowerCase()||e&&this.name&&this.name.toLowerCase()===e.toLowerCase())&&(n=!0);let r=n?t||e:this.email||this.name,i=n&&(t||e)||this.name,a=Math.round(this.size/2.3);return s`
    ...
    `}};k([g({context:T})],mn.prototype,`settingsStore`,void 0),k([o({type:String})],mn.prototype,`name`,void 0),k([o({type:String})],mn.prototype,`email`,void 0),k([o({type:String})],mn.prototype,`src`,void 0),k([o({type:Number})],mn.prototype,`size`,void 0),k([a()],mn.prototype,`imageError`,void 0),mn=k([m(`alps-avatar`)],mn);var hn=class extends d{constructor(...e){super(...e),this.username=``,this.isMobile=!1,this.currentTab=`messages`,this._handleStoreChange=()=>{this.requestUpdate()}}static{this.styles=[gt,n`
    :host {
      display: block;
      position: relative;
    }
  ...
  `}handleSettings(){window.location.hash=`/settings`}async handleSignOut(){try{this.composeStore&&await this.composeStore.saveAllDirtyDrafts(),await fetch(`/session`,{method:`DELETE`}),Rt.clear(),je(),window.dispatchEvent(new CustomEvent(`session-cleared`)),un(`signedOut`),window.location.hash=`#/login`}catch(e){S.error(`Failed to sign out`,e)}}render(){return s`
  ...
  `]}handleSidebarScroll(e){let t=e.target.scrollTop>0;this.sidebarScrolled!==t&&(this.sidebarScrolled=t)}render(){return s`
    ...
    `}};k([g({context:w})],z.prototype,`i18nStore`,void 0),k([o({type:Array})],z.prototype,`contacts`,void 0),k([o({type:Array})],z.prototype,`uniqueCategories`,void 0),k([o({type:String})],z.prototype,`selectedCategory`,void 0),k([o({type:String})],z.prototype,`filterQuery`,void 0),k([o({type:Boolean})],z.prototype,`sidebarCollapsed`,void 0),k([o({type:Boolean})],z.prototype,`isSidebarHovered`,void 0),k([o({type:Boolean})],z.prototype,`suppressSidebarHover`,void 0),k([o({type:Boolean})],z.prototype,`isMobile`,void 0),k([a()],z.prototype,`activeKebabMenu`,void 0),k([a()],z.prototype,`sidebarScrolled`,void 0),z=k([m(`alps-contacts-categories`)],z);var bn=new class extends EventTarget{async createMailbox(e){console.log(`createMailbox`,e);try{let t=new URLSearchParams;t.append(`name`,e);let n=await E(`/mailboxes`,{method:`POST`,headers:{"Content-Type":`application/x-www-form-urlencoded`},body:t.toString()});return n.status===401?(this.dispatchEvent(new CustomEvent(`auth-error`)),window.dispatchEvent(new CustomEvent(`auth-error`)),!1):n.ok?(F.sync(),!0):(S.error(`Create request failed`,n),!1)}catch(e){return S.error(`Failed to create mailbox`,e),!1}}async renameMailbox(e,t){console.log(`renameMailbox`,e,t);try{let n=await E(`/mailboxes/${D(e)}/rename`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({new_name:t})});return n.status===401?(this.dispatchEvent(new CustomEvent(`auth-error`)),window.dispatchEvent(new CustomEvent(`auth-error`)),!1):n.ok?(F.sync(),!0):(S.error(`Rename request failed`,n),!1)}catch(e){return S.error(`Failed to rename mailbox`,e),!1}}async deleteMailbox(e){console.log(`deleteMailbox`,e);try{let t=await E(`/mailboxes/${D(e)}`,{method:`DELETE`});return t.status===401?(this.dispatchEvent(new CustomEvent(`auth-error`)),window.dispatchEvent(new CustomEvent(`auth-error`)),!1):t.ok?(F.sync(),!0):(S.error(`Delete request failed`,t),!1)}catch(e){return S.error(`Failed to delete mailbox`,e),!1}}async emptyMailbox(e){console.log(`emptyMailbox`,e);try{let t=await E(`/mailboxes/${D(e)}/empty`,{method:`POST`});return t.status===401?(this.dispatchEvent(new CustomEvent(`auth-error`)),window.dispatchEvent(new CustomEvent(`auth-error`)),!1):t.ok?(F.sync(),!0):(S.error(`Empty request failed`,t),!1)}catch(e){return S.error(`Failed to empty mailbox`,e),!1}}async subscribeMailbox(e){try{let t=await E(`/mailboxes/${D(e)}/subscribe`,{method:`PUT`});return t.status===401?(this.dispatchEvent(new CustomEvent(`auth-error`)),window.dispatchEvent(new CustomEvent(`auth-error`)),!1):t.ok?(F.sync(),!0):!1}catch(e){return S.error(`Failed to subscribe mailbox`,e),!1}}async unsubscribeMailbox(e){try{let t=await E(`/mailboxes/${D(e)}/unsubscribe`,{method:`PUT`});return t.status===401?(this.dispatchEvent(new CustomEvent(`auth-error`)),window.dispatchEvent(new CustomEvent(`auth-error`)),!1):t.ok?(F.sync(),!0):!1}catch(e){return S.error(`Failed to unsubscribe mailbox`,e),!1}}},xn=class extends d{constructor(...e){super(...e),this.name=``,this.color=``}static{this.styles=n`
    :host {
      display: inline-flex;
    }
  ...
  `}changePage(e){let t=this.currentPage+e;t>=0&&t<Math.ceil(this.totalItems/this.itemsPerPage)&&this.dispatchEvent(new CustomEvent(`change-page`,{detail:{page:t},bubbles:!0,composed:!0}))}render(){let e=this.currentPage*this.itemsPerPage+1,t=Math.min((this.currentPage+1)*this.itemsPerPage,this.totalItems);return s`
    ...
    `}};k([o({type:Number})],Sn.prototype,`currentPage`,void 0),k([o({type:Number})],Sn.prototype,`totalItems`,void 0),k([o({type:Number})],Sn.prototype,`itemsPerPage`,void 0),k([g({context:w})],Sn.prototype,`i18nStore`,void 0),Sn=k([m(`alps-pagination`)],Sn);var Cn=class extends d{constructor(...e){super(...e),this.variant=`info`}static{this.styles=n`
    :host {
      display: block;
      position: sticky;
      top: 0;
  ...
  `}get visibleMessages(){let e=[];for(let t of this.messages||[])e.push(t),t.SubMessages&&t.SubMessages.length>0&&this.isThreadExpanded(String(t.UID))&&e.push(...t.SubMessages);return e}isThreadExpanded(e){return this.expandedThreads.has(e)}toggleThreadCollapse(e,t){e.stopPropagation();let n=new Set(this.expandedThreads);n.has(t)?n.delete(t):n.add(t),this.expandedThreads=n}handleSelectAll(e){if(e.target.checked){let e=this.visibleMessages.map(e=>String(e.UID));this.selectedMessages=new Set(e)}else this.selectedMessages=new Set;this.dispatchEvent(new CustomEvent(`selection-changed`,{detail:{selectedUids:this.selectedMessages}}))}handleSelectMessage(e,t){e.stopPropagation();let n=e.target.checked,r=new Set(this.selectedMessages);n?r.add(t):r.delete(t),this.selectedMessages=r,this.dispatchEvent(new CustomEvent(`selection-changed`,{detail:{selectedUids:this.selectedMessages}}))}connectedCallback(){super.connectedCallback(),F.addEventListener(`sync-start`,this.handleSyncStart),F.addEventListener(`sync-success`,this.handleSyncEnd),F.addEventListener(`sync-error`,this.handleSyncEnd),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleStoreChange)})}disconnectedCallback(){super.disconnectedCallback(),F.removeEventListener(`sync-start`,this.handleSyncStart),F.removeEventListener(`sync-success`,this.handleSyncEnd),F.removeEventListener(`sync-error`,this.handleSyncEnd),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange)}willUpdate(e){if(super.willUpdate(e),(e.has(`currentMailbox`)||e.has(`currentPage`)||e.has(`filterQuery`)||e.has(`sortOrder`))&&(this.selectedMessages.size>0&&(this.selectedMessages=new Set,this.dispatchEvent(new CustomEvent(`selection-changed`,{detail:{selectedUids:this.selectedMessages}}))),this._shouldScrollToTop=!0),e.has(`selectedMessage`)||e.has(`messages`)){if(e.has(`messages`)&&this.messages&&this.selectedMessages.size>0){let e=new Set;for(let t of this.messages)if(e.add(String(t.UID)),t.SubMessages)for(let n of t.SubMessages)e.add(String(n.UID));let t=!1,n=new Set;for(let r of this.selectedMessages)e.has(r)?n.add(r):t=!0;t&&(this.selectedMessages=n,this.dispatchEvent(new CustomEvent(`selection-changed`,{detail:{selectedUids:this.selectedMessages}})))}if(this.selectedMessage){if(this.messages){let e=!1,t=new Set(this.expandedThreads);for(let n of this.messages)if(n.SubMessages&&n.SubMessages.some(e=>String(e.UID)===String(this.selectedMessage.UID))){let r=String(n.UID);t.has(r)||(t.add(r),e=!0)}e&&(this.expandedThreads=t)}let e=this.visibleMessages;if(e.length>0){let t=e.findIndex(e=>String(e.UID)===String(this.selectedMessage.UID));t!==-1&&(this.focusedIndex=t)}}}}checkScrollState(e){if(!e)return;let t=e.scrollTop>0;this.isScrolled!==t&&(this.isScrolled=t,this.dispatchEvent(new CustomEvent(`list-scrolled`,{detail:{scrolled:t}})));let n=e.scrollHeight<=e.clientHeight||Math.ceil(e.scrollTop+e.clientHeight)>=e.scrollHeight;this.isAtBottom!==n&&(this.isAtBottom=n)}updated(e){if(super.updated(e),e.has(`densityMode`)&&(this.classList.remove(`density-loose`,`density-normal`,`density-compact`,`density-ultra-compact`),this.classList.add(`density-${this.densityMode}`)),e.has(`syncing`)&&this.syncing&&(this.isSpinning=!0),e.has(`selectedMessage`)&&this.selectedMessage&&setTimeout(()=>{let e=this.renderRoot.querySelector(`.list-content`)?.querySelector(`.message-item.active`);e&&e.scrollIntoView({behavior:`smooth`,block:`center`})},50),this._shouldScrollToTop&&(e.has(`messages`)||e.has(`loading`)&&!this.loading)){let e=this.renderRoot.querySelector(`.list-content`);e&&(e.scrollTop=0),this._shouldScrollToTop=!1}let t=this.renderRoot.querySelector(`.list-content`);t&&requestAnimationFrame(()=>{this.checkScrollState(t)})}selectMessage(e){this.selectedMessages.size>0&&(this.selectedMessages=new Set,this.dispatchEvent(new CustomEvent(`selection-changed`,{detail:{selectedUids:this.selectedMessages}}))),this.dispatchEvent(new CustomEvent(`select-message`,{detail:{message:e}}))}handleKeyDown(e){let t=this.visibleMessages;if(!(!t||t.length===0)){if(e.key===`ArrowDown`)e.preventDefault(),this.focusedIndex=Math.min(t.length-1,this.focusedIndex+1),this.scrollToFocused();else if(e.key===`ArrowUp`)e.preventDefault(),this.focusedIndex=Math.max(0,this.focusedIndex-1),this.scrollToFocused();else if(e.key===`Enter`)e.preventDefault(),this.focusedIndex>=0&&this.focusedIndex<t.length&&this.selectMessage(t[this.focusedIndex]);else if(e.key===` `&&(e.preventDefault(),this.focusedIndex>=0&&this.focusedIndex<t.length)){let e=t[this.focusedIndex],n=String(e.UID),r=new Set(this.selectedMessages);r.has(n)?r.delete(n):r.add(n),this.selectedMessages=r,this.dispatchEvent(new CustomEvent(`selection-changed`,{detail:{selectedUids:this.selectedMessages}})),this.focusedIndex=Math.min(t.length-1,this.focusedIndex+1),this.scrollToFocused()}}}async handleEmptyMailbox(){this.showEmptyConfirm=!1,this.dispatchEvent(new CustomEvent(`toast`,{detail:{type:`info`,message:this.i18nStore?.t(`messageList.emptyingMailbox`)||`Emptying mailbox...`},bubbles:!0,composed:!0})),await bn.emptyMailbox(this.currentMailbox)?this.dispatchEvent(new CustomEvent(`toast`,{detail:{type:`success`,message:this.i18nStore?.t(`messageList.mailboxEmptied`)||`Mailbox emptied successfully.`},bubbles:!0,composed:!0})):this.dispatchEvent(new CustomEvent(`toast`,{detail:{type:`error`,message:this.i18nStore?.t(`messageList.emptyMailboxFailed`)||`Failed to empty mailbox. Make sure it is Trash or Junk.`},bubbles:!0,composed:!0}))}scrollToFocused(){this.updateComplete.then(()=>{let e=this.renderRoot.querySelector(`.message-item.focused`);e&&e.scrollIntoView({block:`nearest`})})}renderMessageItem(e,t=!1,n=!1,r=!1){let i=this.currentMailboxRole===`drafts`||this.currentMailboxRole===`sent`||this.currentMailbox===`Drafts`||this.currentMailbox===`Sent`,a=[];i?(a=[...e.Envelope?.To||[],...e.Envelope?.Cc||[]],a.length||(a=e.Envelope?.From||[])):a=[...e.Envelope?.From||[],...e.Envelope?.To||[],...e.Envelope?.Cc||[]];let o=new Set,c=[];for(let e of a){let t=(e.Mailbox&&e.Host?`${e.Mailbox}@${e.Host}`.toLowerCase():``)||e.Name||`unknown`;t!==`unknown`&&!o.has(t)?(o.add(t),c.push(e)):t===`unknown`&&c.push(e)}let l=this.settingsStore?.getState()?.loginUsername?.toLowerCase()||``,u=e=>{let t=e.Mailbox&&e.Host?`${e.Mailbox}@${e.Host}`.toLowerCase():``;return!!(l&&t===l)};if(c.length>1){let e=c.filter(e=>!u(e));e.length>0&&(c=e)}c.length||(c=[{}]);let d=i?`messageList.noRecipient`:`messageList.unknownSender`,f=c.map(e=>{let t=e.Mailbox&&e.Host?`${e.Mailbox}@${e.Host}`:``;return e.Name||t||this.i18nStore?.t(d)||this.i18nStore?.t(`messageList.unknown`)}).join(`, `),p=this.isMobile?1:3,m=c.slice(0,p),h=c.length-p,g=m.length+ +(h>0),_=e.Envelope?.Subject||this.i18nStore?.t(`messageList.noSubject`),ee=this.settingsStore?.getState()?.dateFormat||`YYYY-MM-DD`,v=String(this.settingsStore?.getState()?.hourFormat||`12`),y=e.Envelope?.Date?$e(e.Envelope.Date,ee,v):``,b=e.RFC822Size||e.Size,te=b?nt(b):``,ne=!e.Flags||!e.Flags.includes(`\\Seen`),re=e.Flags&&e.Flags.includes(`\\Flagged`),ie=e.Flags&&e.Flags.includes(`\\Answered`),ae=e.Flags&&e.Flags.includes(`$Forwarded`),oe=Qt(e.Flags,this.i18nStore),se=this.densityMode===`loose`?48:this.densityMode===`compact`?24:40,ce=e.SubMessages&&e.SubMessages.length>0,x=this.isThreadExpanded(String(e.UID));return this.densityMode===`ultra-compact`?s`
      <div class="message-item ${t?`sub-message-item`:``} ${n?`first-sub-item`:``} ${r?`last-sub-item`:``} ${this.selectedMessages.size===0&&this.selectedMessage?.UID===e.UID||this.selectedMessages.has(String(e.UID))?`active`:``} ${ne?`unread`:``} ${re?`starred`:``} ${this.focusedIndex===this.visibleMessages.indexOf(e)?`focused`:``}" @click=${()=>this.selectMessage(e)}>
        ...
        <div @click=${t=>this.toggleStar(t,e)} class="star-btn ${re?`starred`:``} star-btn-wrapper-ultra">
          ${O(re?`starFourFill`:`starFour`)}
        </div>
        ${ie||ae?s`
          <div class="indicators-wrapper-ultra">
            ${ie?s`<div class="indicator-icon" title=${this.i18nStore?.t(`messageList.replied`)}>${O(`arrowBendUpLeft`)}</div>`:``}
            ${ae?s`<div class="indicator-icon" title=${this.i18nStore?.t(`messageList.forwarded`)}>${O(`arrowBendUpRight`)}</div>`:``}
          </div>
        `:``}
        ${oe.length>0?s`
          <div class="tag-pills">
      ...
      <div class="avatar-stack">
        ${m.map((e,t)=>{let n=e.Mailbox&&e.Host?`${e.Mailbox}@${e.Host}`:``,r=e.Name||n||this.i18nStore?.t(d)||this.i18nStore?.t(`messageList.unknown`),i=it(e.Host?e.Host.toLowerCase():``);return s`
            <div class="avatar-wrapper" style="z-index: ${g-t};">
              <alps-avatar .name=${r} .email=${n} .size=${se} .src=${i}></alps-avatar>
            </div>
          `})}
        ${h>0?s`
          <div class="avatar-wrapper extra-count" style="width: ${se}px; height: ${se}px; z-index: 0;">
            +${h}
          </div>
        `:``}
      </div>
      <div class="message-details">
        <div class="message-header-row">
          <div class="message-header-inner">
            <div class="message-sender">${f}</div>
            <div @click=${t=>this.toggleStar(t,e)} class="star-btn ${re?`starred`:``}">
              ${O(re?`starFourFill`:`starFour`)}
            </div>
          </div>
          <div class="message-indicators">
    ...
    `}toggleStar(e,t){e.stopPropagation(),this.dispatchEvent(new CustomEvent(`toggle-star-message`,{detail:{message:t}}))}render(){return s`
      ...
      <div class="list-content ${this.loading&&this.messages.length>0?`loading-overlay`:``}" tabindex="0" @scroll=${this.handleScroll} @keydown=${this.handleKeyDown}>
        ...
        `:``}
        ${!this.filterQuery&&Ze(this.currentMailbox)&&this.totalMessages>0?s`
  ...
  `]}formatRevision(e){if(!e)return``;let t=e;t.length===16&&t.indexOf(`-`)===-1&&(t=`${t.slice(0,4)}-${t.slice(4,6)}-${t.slice(6,8)}T${t.slice(9,11)}:${t.slice(11,13)}:${t.slice(13,16)}`);let n=this.settingsStore?.getState()?.dateFormat||`YYYY-MM-DD`,r=String(this.settingsStore?.getState()?.hourFormat||`12`);return $e(new Date(t),n,r)}handleKeyDown(e){let t=this.getFilteredContacts();if(t.length!==0){if(e.key===`ArrowDown`)e.preventDefault(),this.focusedIndex=Math.min(t.length-1,this.focusedIndex+1),this.scrollToFocused();else if(e.key===`ArrowUp`)e.preventDefault(),this.focusedIndex=Math.max(0,this.focusedIndex-1),this.scrollToFocused();else if(e.key===`Enter`)e.preventDefault(),this.focusedIndex>=0&&this.focusedIndex<t.length&&this.dispatchEvent(new CustomEvent(`select-contact`,{detail:{contact:t[this.focusedIndex]}}));else if(e.key===` `&&(e.preventDefault(),this.focusedIndex>=0&&this.focusedIndex<t.length)){let n=t[this.focusedIndex];n.isTemporary||this.dispatchEvent(new CustomEvent(`toggle-selection`,{detail:{path:n.path,event:e}})),this.focusedIndex=Math.min(t.length-1,this.focusedIndex+1),this.scrollToFocused()}}}scrollToFocused(){this.updateComplete.then(()=>{let e=this.renderRoot.querySelector(`.contact-item.focused`);e&&e.scrollIntoView({block:`nearest`})})}handleListScroll(e){let t=e.target.scrollTop>0;this.listScrolled!==t&&(this.listScrolled=t,this.dispatchEvent(new CustomEvent(`list-scrolled`,{detail:{scrolled:t}})))}render(){return s`
    ...
    `}};k([g({context:w})],V.prototype,`i18nStore`,void 0),k([g({context:T})],V.prototype,`settingsStore`,void 0),k([o({type:Array})],V.prototype,`contacts`,void 0),k([o({type:String})],V.prototype,`selectedCategory`,void 0),k([o({type:String})],V.prototype,`filterQuery`,void 0),k([o({type:String})],V.prototype,`sortOrder`,void 0),k([o({type:Boolean})],V.prototype,`showOnlyStarred`,void 0),k([o({type:Boolean})],V.prototype,`isMobile`,void 0),k([o({type:String})],V.prototype,`densityMode`,void 0),k([o({type:Object})],V.prototype,`selectedContacts`,void 0),k([o({type:Object})],V.prototype,`selectedContact`,void 0),k([o({type:Boolean})],V.prototype,`isSpinning`,void 0),k([o({type:Boolean})],V.prototype,`loading`,void 0),k([o({type:Boolean})],V.prototype,`listScrolled`,void 0),k([a()],V.prototype,`focusedIndex`,void 0),V=k([m(`alps-contacts-list`)],V);function wn(e){return function(t,n){let r=e.indexOf(t.fullName),i=e.indexOf(n.fullName);return r!==-1&&i!==-1?r-i:r===-1?i===-1?t.standardOrder>=0&&n.standardOrder>=0?t.standardOrder-n.standardOrder:t.standardOrder>=0?-1:n.standardOrder>=0?1:t.name.localeCompare(n.name):1:-1}}var H=class extends d{constructor(...e){super(...e),this.mailboxes=[],this.currentMailbox=``,this.expandedFolders=new Set,this.layoutMode=`vertical`,this.syncing=!1,this.collapsed=!1,this.isScrolled=!1,this.showCreatePrompt=!1,this.showRenamePrompt=!1,this.mailboxToRename=``,this.showDeleteConfirm=!1,this.showMoveToTrashConfirm=!1,this.mailboxToDelete=``,this.parentForNewFolder=``,this.activeKebabMenu=null,this.primaryFullNames=new Set,this._handleStoreChange=()=>{this.requestUpdate()},this.handleScroll=e=>{let t=e.target;this.isScrolled=t.scrollTop>0}}willUpdate(e){super.willUpdate(e)}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.composeStore&&this.composeStore.addEventListener(`change`,this._handleStoreChange),this.i18nStore&&this.i18nStore.addEventListener(`change`,this._handleStoreChange),this.settingsStore&&this.settingsStore.addEventListener(`change`,this._handleStoreChange)})}disconnectedCallback(){super.disconnectedCallback(),this.composeStore&&this.composeStore.removeEventListener(`change`,this._handleStoreChange),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange),this.settingsStore?.removeEventListener(`change`,this._handleStoreChange)}static{this.styles=[gt,st,n`
    :host {
      display: flex;
      flex-direction: column;
      flex: 1;
  ...
  `]}toggleFolder(e,t){e&&e.stopPropagation(),this.dispatchEvent(new CustomEvent(`toggle-folder`,{detail:{folderName:t}}))}selectMailbox(e){this.dispatchEvent(new CustomEvent(`select-mailbox`,{detail:{name:e}}))}triggerCreateFolder(){this.parentForNewFolder=``,this.showCreatePrompt=!0}handleCreateSubmit(e){let t=e.detail.name;if(t){if(this.parentForNewFolder){let e=this.mailboxes.find(e=>(e.Name||e.Mailbox)===this.parentForNewFolder),n=`.`;if(e){let t=e.Delimiter||e.Delim;n=typeof t==`number`?String.fromCharCode(t):t||`.`}t=`${this.parentForNewFolder}${n}${t}`,this.dispatchEvent(new CustomEvent(`expand-folder`,{detail:{folderName:this.parentForNewFolder}}))}bn.createMailbox(t)}this.showCreatePrompt=!1,this.parentForNewFolder=``}async handleRenameSubmit(e){let t=e.detail.name;if(t&&this.mailboxToRename){let e=this.mailboxToRename;this.showRenamePrompt=!1,this.mailboxToRename=``,await bn.renameMailbox(e,t)&&(this.currentMailbox===e&&this.selectMailbox(t),this.dispatchEvent(new CustomEvent(`toast`,{detail:{message:this.i18nStore?.t(`toast.folderRenamed`),actionLabel:this.i18nStore?.t(`toast.undo`),actionFn:async()=>{await bn.renameMailbox(t,e),this.currentMailbox===t&&this.selectMailbox(e)},duration:5e3},bubbles:!0,composed:!0})))}else this.showRenamePrompt=!1,this.mailboxToRename=``}async handleDeleteConfirm(){this.mailboxToDelete&&await bn.deleteMailbox(this.mailboxToDelete)&&(this.currentMailbox.startsWith(this.mailboxToDelete)&&this.selectMailbox(`-`),this.dispatchEvent(new CustomEvent(`toast`,{detail:{message:this.i18nStore?.t(`toast.folderPermanentlyDeleted`),duration:3e3},bubbles:!0,composed:!0}))),this.showDeleteConfirm=!1,this.mailboxToDelete=``}async handleMoveToTrashConfirm(){if(this.mailboxToDelete){let e=this.mailboxes.find(e=>(e.Name||e.Mailbox)===this.mailboxToDelete);if(!e){console.log(`handleMoveToTrashConfirm: no mailbox found for ${this.mailboxToDelete}`),this.showMoveToTrashConfirm=!1,this.mailboxToDelete=``;return}let t=e.Delimiter||e.Delim,n=typeof t==`number`?String.fromCharCode(t):t||`.`,r=this.mailboxToDelete.split(n),i=r[r.length-1],a=Xe(`trash`,this.mailboxToDelete,this.mailboxes,`Trash`),o=`${a}${n}${i}`,s=1;for(;this.mailboxes.some(e=>(e.Name||e.Mailbox)===o);)o=`${a}${n}${i} (${s})`,s++;let c=o;if(await bn.renameMailbox(this.mailboxToDelete,c)){this.currentMailbox.startsWith(this.mailboxToDelete)&&this.selectMailbox(`-`);let e=this.mailboxToDelete;this.dispatchEvent(new CustomEvent(`toast`,{detail:{message:this.i18nStore?.t(`toast.folderMovedToTrash`),actionLabel:this.i18nStore?.t(`toast.undo`),actionFn:async()=>{await bn.renameMailbox(c,e)},duration:5e3},bubbles:!0,composed:!0}))}}this.showMoveToTrashConfirm=!1,this.mailboxToDelete=``}moveFolder(e,t){console.log(`[moveFolder] Start:`,e.fullName,t);let n=Object.values(e.siblings);console.log(`[moveFolder] Sibling custom folders found:`,n);let r=[...this.settingsStore?.getState()?.customMailboxOrder||[]];n.sort(wn(r)),console.log(`[moveFolder] Sorted siblings:`,n);let i=n.map(e=>e.fullName),a=i.indexOf(e.fullName);if(a===-1){console.error(`[moveFolder] Folder not found in siblings!`);return}let o=a;switch(t){case`top`:o=0;break;case`up`:o=Math.max(0,a-1);break;case`down`:o=Math.min(i.length-1,a+1);break;case`bottom`:o=i.length-1;break}if(console.log(`[moveFolder] Shifting indexes:`,{currentIndex:a,newIndex:o}),o===a){console.log(`[moveFolder] No index change needed.`);return}i.splice(a,1),i.splice(o,0,e.fullName),console.log(`[moveFolder] New siblings order:`,i);let s=r.filter(e=>!i.includes(e));s.push(...i),console.log(`[moveFolder] Final updated customMailboxOrder settings state:`,s),this.settingsStore?.updateSettings({customMailboxOrder:s})}render(){let e=[{attr:`\\inbox`,names:[Le],display:{icon:`tray`,colorClass:`icon-inbox`,label:this.i18nStore?.t(`folderList.inbox`)}},{attr:`\\drafts`,names:[Re],display:{icon:`fileText`,colorClass:`icon-drafts`,label:this.i18nStore?.t(`folderList.drafts`)}},{attr:`\\sent`,names:[ze],display:{icon:`paperPlaneTilt`,colorClass:`icon-sent`,label:this.i18nStore?.t(`folderList.sent`)}},{attr:`\\archive`,names:[Be,Ve],display:{icon:`archiveBox`,colorClass:`icon-archive`,label:this.i18nStore?.t(`folderList.archive`)}},{attr:`\\junk`,names:[Ue,He],display:{icon:`warningDiamond`,colorClass:`icon-spam`,label:this.i18nStore?.t(`folderList.junk`)}},{attr:`\\trash`,names:[We],display:{icon:`trash`,colorClass:`icon-trash`,label:this.i18nStore?.t(`folderList.trash`)}}],t={[Le]:{icon:`tray`,colorClass:`icon-inbox`,label:this.i18nStore?.t(`folderList.inbox`)},[Re]:{icon:`fileText`,colorClass:`icon-drafts`,label:this.i18nStore?.t(`folderList.drafts`)},[ze]:{icon:`paperPlaneTilt`,colorClass:`icon-sent`,label:this.i18nStore?.t(`folderList.sent`)},[Be]:{icon:`archiveBox`,colorClass:`icon-archive`,label:this.i18nStore?.t(`folderList.archive`)},[Ve]:{icon:`archiveBox`,colorClass:`icon-archive`,label:this.i18nStore?.t(`folderList.archive`)},[He]:{icon:`warningDiamond`,colorClass:`icon-spam`,label:this.i18nStore?.t(`folderList.spam`)},[Ue]:{icon:`warningDiamond`,colorClass:`icon-spam`,label:this.i18nStore?.t(`folderList.junk`)},[We]:{icon:`trash`,colorClass:`icon-trash`,label:this.i18nStore?.t(`folderList.trash`)}},n=e=>({name:e,standardBySlot:new Map}),r={},i=n(`@unified`),a=new Map,o=e=>{let t=a.get(e);return t||(t=n(e),a.set(e,t)),t};this.mailboxes.forEach(e=>{let t=e.Name||e.Mailbox||``,n=e.Delimiter||e.Delim,a=typeof n==`number`?String.fromCharCode(n):n||`.`,s=t.split(a),c=r,l=``,u=i;s[0].startsWith(`@`)&&(u=o(s[0]));for(let t=0;t<s.length;t++){let n=s[t];l=t===0?n:l+a+n,c[n]||(c[n]={account:u,name:n,fullName:l,children:{},siblings:c,standardOrder:-1}),t===s.length-1&&(c[n].mb=e),c=c[n].children}});let c=e=>(e.mb?.Attrs||[]).map(e=>typeof e==`string`?e.toLowerCase():``),l=(e,t)=>{let n=c(e);return n.includes(t)||n.includes(`\\`+t)},u=t=>{let n=c(t);for(let t=0;t<e.length;t++){let r=e[t];if(n.includes(r.attr)||n.includes(`\\`+r.attr))return t}if(t.mb&&!n.includes(`\\noselect`)&&!n.includes(`\\nonexistent`)){for(let n=0;n<e.length;n++)if(e[n].names.includes(t.name))return n}return-1},d=[],f=t=>n=>{if(n.name==n.account.name){d.push(n),Object.values(n.children).forEach(f(!1));return}let r=u(n);if(r<0){t&&d.push(n);return}let i=n.account.standardBySlot,a=i.get(r);if(!a){i.set(r,n);return}let o=e[r],s=l(n,o.attr),c=l(a,o.attr),p=o.names.indexOf(n.name),m=o.names.indexOf(a.name);s&&!c||s===c&&p!==-1&&(m===-1||p<m)?(i.set(r,n),t&&d.push(a)):t&&d.push(n)};Object.values(r).forEach(f(!0));let p=[];i.standardBySlot.forEach((n,r)=>{n.primary=t[n.name]||e[r].display,n.standardOrder=r,p.push(n)}),this.primaryFullNames=new Set(p.map(e=>e.fullName)),a.forEach(n=>{n.standardBySlot.forEach((n,r)=>{n.primary=t[n.name]||e[r].display,n.standardOrder=r})});let m=wn(this.settingsStore?.getState()?.customMailboxOrder||[]);d.sort(m);let h=(e,t=0)=>e.map(e=>{let n=Object.keys(e.children).length>0,r=this.expandedFolders.has(e.fullName),i=this.currentMailbox===e.fullName,a=t>0&&!e.primary,o=!1,c=!1;if(t>0){let t=Object.values(e.siblings).filter(e=>!this.primaryFullNames.has(e.fullName));t.sort(m),t.length>0&&(o=e.fullName===t[0].fullName,c=e.fullName===t[t.length-1].fullName)}let l=O(`folder`),u=`icon-default`,d=e.name;e.primary&&(l=O(e.primary.icon),u=e.primary.colorClass,d=e.primary.label);let f=e.mb?.Unseen||0,p=(e.mb?.Attrs||[]).some(e=>typeof e==`string`&&e.toLowerCase()===`\\noselect`),g=t=>{p?n&&this.toggleFolder(t,e.fullName):this.selectMailbox(e.fullName)},_=e.primary,ee=e.name.startsWith(`@`),v=[];return _||v.push(s`
          ...
          `),v.length>0&&v.push(s`<div class="dropdown-divider"></div>`),v.push(s`
            <alps-popup position="right" align="top" triggerOn="hover" @click=${e=>e.stopPropagation()}>
              ...
              <button class="dropdown-item" ?disabled=${o} @click=${t=>{let n=t.target.closest(`alps-popup`);n&&n.close();let r=t.target.closest(`.folder-actions`)?.querySelector(`alps-popup`);r&&r.close(),this.moveFolder(e,`top`)}}>
                ${O(`caretDoubleUp`)} <span class="item-text">Move to Top</span>
              </button>
              <button class="dropdown-item" ?disabled=${o} @click=${t=>{let n=t.target.closest(`alps-popup`);n&&n.close();let r=t.target.closest(`.folder-actions`)?.querySelector(`alps-popup`);r&&r.close(),this.moveFolder(e,`up`)}}>
          ...
          `),!ee&&!_&&(v.length>0&&v.push(s`<div class="dropdown-divider"></div>`),v.push(s`
            <button class="dropdown-item" @click=${t=>{let n=t.target.closest(`alps-popup`);n&&n.close(),this.mailboxToDelete=e.fullName,qe(e.mb)===`trash`||Ze(e.fullName)?this.showDeleteConfirm=!0:this.showMoveToTrashConfirm=!0}}>
              ${O(`trash`)} <span class="item-text">${this.i18nStore?.t(`folderList.delete`)}</span>
            </button>
          `)),s`
          <div 
            class="folder-item ${i?`active`:``} ${p?`no-select`:``} ${a?`has-actions`:``}"
            title=${d}
            @click=${g}
          >
            <alps-icon-btn 
      ...
      ${this.showDeleteConfirm?s`
        ...
        ></ui-confirm>
      `:``}
    `}};k([g({context:cn})],H.prototype,`composeStore`,void 0),k([g({context:w})],H.prototype,`i18nStore`,void 0),k([g({context:T})],H.prototype,`settingsStore`,void 0),k([o({type:Array})],H.prototype,`mailboxes`,void 0),k([o({type:String})],H.prototype,`currentMailbox`,void 0),k([o({type:Object})],H.prototype,`expandedFolders`,void 0),k([o({type:String})],H.prototype,`layoutMode`,void 0),k([o({type:Boolean})],H.prototype,`syncing`,void 0),k([o({type:Boolean,reflect:!0})],H.prototype,`collapsed`,void 0),k([a()],H.prototype,`isScrolled`,void 0),k([a()],H.prototype,`showCreatePrompt`,void 0),k([a()],H.prototype,`showRenamePrompt`,void 0),k([a()],H.prototype,`mailboxToRename`,void 0),k([a()],H.prototype,`showDeleteConfirm`,void 0),k([a()],H.prototype,`showMoveToTrashConfirm`,void 0),k([a()],H.prototype,`mailboxToDelete`,void 0),k([a()],H.prototype,`parentForNewFolder`,void 0),k([a()],H.prototype,`activeKebabMenu`,void 0),H=k([m(`alps-folder-list`)],H);var Tn=class extends d{constructor(...e){super(...e),this.name=``,this.address=``}static{this.styles=n`
    :host {
      display: inline;
    }
  ...
  `}handleClick(){this.composeStore.openComposer({to:[this.address]})}render(){let e=this.name;return e===this.address&&(e=``),e?s`
      ...
      `}};k([g({context:cn})],Tn.prototype,`composeStore`,void 0),k([o({type:String})],Tn.prototype,`name`,void 0),k([o({type:String})],Tn.prototype,`address`,void 0),Tn=k([m(`alps-recipient-pill`)],Tn);var En=class extends d{constructor(...e){super(...e),this.attachment=null,this.downloadUrl=``,this.fallbackName=`Unknown attachment`,this.removable=!1,this.compact=!1}static{this.styles=n`
    .attachment-chip {
      display: inline-flex;
      align-items: center;
      width: 100%;
  ...
  `}render(){return!this.attachments||this.attachments.length===0?s``:s`
    ...
    `}};k([g({context:w})],Dn.prototype,`i18nStore`,void 0),k([o({type:Array})],Dn.prototype,`attachments`,void 0),k([o({type:String})],Dn.prototype,`mailbox`,void 0),k([o({type:String})],Dn.prototype,`messageUid`,void 0),k([o({type:Boolean})],Dn.prototype,`removable`,void 0),k([o({type:Boolean,reflect:!0})],Dn.prototype,`composerMode`,void 0),k([a()],Dn.prototype,`attachmentsExpanded`,void 0),Dn=k([m(`alps-attachment-list`)],Dn);var U=class extends d{constructor(...e){super(...e),this.mailboxes=[],this.currentMailbox=``,this.noActionBox=!1,this.noSearchBox=!1,this.filterQuery=``,this.isMove=!0}static{this.styles=n`
    :host {
      display: inline-block;
    }
...
`).trim()}function Ln(e,t,n,r){if(!e)return n||r;let i=e;if(t?.toLowerCase()===`text/html`||e.trim().startsWith(`<`)||/<\/[a-zA-Z]+>/.test(e)||/<[a-zA-Z]+[^>]*>/.test(e))try{let t=new DOMParser().parseFromString(e,`text/html`);t.querySelectorAll(`style, script, head`).forEach(e=>e.remove());let n=e=>{if(e.nodeType===Node.TEXT_NODE)return e.textContent||``;if(e.nodeType===Node.ELEMENT_NODE){let t=e,r=t.tagName.toLowerCase();if(r===`br`)return` `;let i=``;for(let e=0;e<t.childNodes.length;e++)i+=n(t.childNodes[e]);return[`p`,`div`,`td`,`tr`,`th`,`li`,`h1`,`h2`,`h3`,`h4`,`h5`,`h6`,`section`,`article`,`blockquote`,`ol`,`ul`,`header`,`footer`].includes(r)?` `+i+` `:i}return``};i=n(t.body||t)}catch{i=e.replace(/<[^>]*>/g,` `)}else i=e.replace(/[\r\n\t]+/g,` `);let a=i.replace(/\s+/g,` `).trim();if(a){let e=a.substring(0,100);return a.length>100?e+`...`:e}else if(n)return n.replace(/[\r\n\t\s]+/g,` `).trim();else return r}var Rn=class extends d{static{this.styles=n`
  ...
  `]}updated(e){e.has(`message`)&&this.message&&setTimeout(()=>{let e=`thread-card-${this.message?.UID}`,t=this.shadowRoot?.getElementById(e);t&&t.scrollIntoView({behavior:`smooth`,block:`start`})},50)}willUpdate(e){let t=e.has(`message`),n=e.has(`mailbox`),r=e.has(`messages`);if(t||n){let t=e.get(`message`),n=e.has(`mailbox`)?e.get(`mailbox`):this.mailbox;this.message?!t||t.UID!==this.message.UID||n!==this.mailbox?(this.localPreferredView=null,this.fetchMessageBody(this.message,this.message._isAutosaveUpdate)):(t&&(t.HasBimiPotential&&!this.message.HasBimiPotential&&(this.message={...this.message,HasBimiPotential:!0}),t.HasBimiFailed&&!this.message.HasBimiFailed&&(this.message={...this.message,HasBimiFailed:!0})),this.resolveThread(this.message),this.message._isAutosaveUpdate&&t&&this.message!==t&&this.fetchMessageBody(this.message,!0)):(this.localPreferredView=null,this.content=``,this.mimeType=``,this.rawMessageHtml=``,this.loading=!1,this.allowRemoteResources=!1,this.hasRemoteResources=!1,this.hasHtml=!1,this.hasText=!1,this.activeBanners=[],this.threadItems=[])}else r&&this.message&&this.resolveThread(this.message)}loadRemoteResources(){this.allowRemoteResources=!0,this.rawMessageHtml&&(this.content=jn(this.rawMessageHtml,{mailbox:this.mailbox,messageUid:this.message?.UID,allowRemoteResources:this.allowRemoteResources,messageStructure:this.message?.BodyStructure,onRemoteResourceBlocked:()=>{this.hasRemoteResources=!0}}))}resolveThread(e){if(!e)return;let t=this.settingsStore?.getState()?.enableThreading??!0,n=[],r=null;if(t&&this.messages&&this.messages.length>0){let t=this.messages.find(t=>String(t.UID)===String(e.UID));if(t)r=t;else for(let t of this.messages)if(t.SubMessages&&t.SubMessages.find(t=>String(t.UID)===String(e.UID))){r=t;break}}r?(n=[r,...r.SubMessages||[]],n.sort((e,t)=>(e.Envelope?.Date?new Date(e.Envelope.Date).getTime():0)-(t.Envelope?.Date?new Date(t.Envelope.Date).getTime():0))):n=[e],this._isThread=t&&n.length>1;let i=this.getSentMailboxName(),a=this.threadItems||[];this.threadItems=n.map(t=>{let n=String(t.UID)===String(e.UID),r=a.find(e=>String(e.message?.UID)===String(t.UID));if(r){let e={...t,Flags:t.Flags||r.message.Flags||[]};return r.message.HasBimiPotential&&(e.HasBimiPotential=!0),r.message.HasBimiFailed&&(e.HasBimiFailed=!0),{...r,message:e}}return{message:t,content:``,mimeType:``,loading:!1,attachments:[],rawMessageHtml:``,hasHtml:!1,hasText:!1,activeBanners:[],allowRemoteResources:this.allowRemoteResources,hasRemoteResources:!1,isSent:(this.mailbox||``).toLowerCase()===i.toLowerCase()||(t.Mailbox||``).toLowerCase()===i.toLowerCase(),mailbox:t.Mailbox||this.mailbox,expanded:n}})}async fetchMessageBody(e,t=!1){e&&(e._isAutosaveUpdate=!1),this.message&&(this.message._isAutosaveUpdate=!1),t||(this.content=``,this.mimeType=``,this.rawMessageHtml=``,this.loading=!0,this.activeBanners=[],this.allowRemoteResources=this.settingsStore?.getState().showRemoteContent===`always`,this.hasRemoteResources=!1,this.threadItems=[]),this.resolveThread(e);let n=this.threadItems.find(t=>String(t.message?.UID)===String(e.UID))||this.threadItems[0];n&&(n.loading=!t,n.expanded=!0,this._deferPropertySync=!1,this.fetchItemBody(n).then(()=>{this.message?.UID!==e.UID||this.mailbox!==e.Mailbox||this.requestUpdate()}))}updateThreadItemReference(e){if(!e.message)return;let t=this.threadItems.findIndex(t=>String(t.message?.UID)===String(e.message?.UID));t!==-1&&(this.threadItems[t]={...e},this.threadItems=[...this.threadItems])}async fetchItemBody(e){if(!e.message)return;let t=e.message,n=e.mailbox,r=this.localPreferredView||this.settingsStore?.getState()?.preferredView||`html`;try{let i=Rt.get(n,t.UID.toString(),r);if(i){if(e.attachments=i.Attachments||[],e.hasHtml=i.HasHTML||!1,e.hasText=i.HasText||!1,i.Message&&(e.message={...t,...i.Message}),i.Part)if(e.mimeType=i.Part.MIMEType||i.Part.MimeType||`text/plain`,i.RawHtml===void 0){if(i.RawText!==void 0){e.content=i.RawText;let t={content:e.content,isHtml:!1,message:e.message,banners:[],i18nStore:this.i18nStore},r=await x.invokeHookAsync(`reader:content`,t);for(let t of r)t&&typeof t==`string`&&(e.content=t);e.activeBanners=t.banners||[],t.isHtml&&(e.mimeType=`text/html`,e.hasHtml=!0,e.content=jn(e.content,{mailbox:n,messageUid:e.message?.UID,allowRemoteResources:e.allowRemoteResources,messageStructure:e.message?.BodyStructure,onRemoteResourceBlocked:()=>{e.hasRemoteResources=!0,String(e.message.UID)===String(this.message?.UID)&&(this.hasRemoteResources=!0)}}))}}else{e.rawMessageHtml=i.RawHtml;let t={content:e.rawMessageHtml,isHtml:!0,message:e.message,banners:[],i18nStore:this.i18nStore},r=await x.invokeHookAsync(`reader:content`,t);for(let t of r)t&&typeof t==`string`&&(e.rawMessageHtml=t);e.activeBanners=t.banners||[],e.content=jn(e.rawMessageHtml,{mailbox:n,messageUid:e.message?.UID,allowRemoteResources:e.allowRemoteResources,messageStructure:e.message?.BodyStructure,onRemoteResourceBlocked:()=>{e.hasRemoteResources=!0,String(e.message.UID)===String(this.message?.UID)&&(this.hasRemoteResources=!0)}})}e.loading=!1,!this._deferPropertySync&&String(e.message.UID)===String(this.message?.UID)&&(this.content=e.content,this.mimeType=e.mimeType,this.rawMessageHtml=e.rawMessageHtml,this.attachments=e.attachments,this.hasHtml=e.hasHtml,this.hasText=e.hasText,this.activeBanners=e.activeBanners,this.allowRemoteResources=e.allowRemoteResources,this.hasRemoteResources=e.hasRemoteResources,this.loading=!1,this.message={...this.message,...e.message}),this.updateThreadItemReference(e);return}let a=await E(`/mailboxes/${D(n)}/messages/${t.UID}?view=${r}`);if(a.status===401){window.location.hash=`/login`;return}if(!a.ok)throw Error(`Failed to fetch metadata`);let o=await a.json();e.attachments=o.Attachments||[],e.hasHtml=!!o.HasHTML,e.hasText=!!o.HasText,o.Message&&(e.message={...e.message,...o.Message});let s,c,l=o.Part;if(l){e.mimeType=l.MIMEType||l.MimeType||`text/plain`;let r=Array.isArray(l.Path)?l.Path.join(`.`):l.Path,i=await E(`/mailboxes/${D(n)}/messages/${t.UID}/raw?part=${r}`);if(i.status===401){window.location.hash=`/login`;return}if(i.ok)if(e.mimeType.toLowerCase()===`text/html`){s=await i.text(),e.rawMessageHtml=s;let t={content:e.rawMessageHtml,isHtml:!0,message:e.message,banners:[],i18nStore:this.i18nStore},r=await x.invokeHookAsync(`reader:content`,t);for(let t of r)t&&typeof t==`string`&&(e.rawMessageHtml=t);e.activeBanners=t.banners||[],e.content=jn(e.rawMessageHtml,{mailbox:n,messageUid:e.message?.UID,allowRemoteResources:e.allowRemoteResources,messageStructure:e.message?.BodyStructure,onRemoteResourceBlocked:()=>{e.hasRemoteResources=!0,String(e.message.UID)===String(this.message?.UID)&&(this.hasRemoteResources=!0)}})}else{c=await i.text(),e.content=c;let t={content:e.content,isHtml:!1,message:e.message,banners:[],i18nStore:this.i18nStore},r=await x.invokeHookAsync(`reader:content`,t);for(let t of r)t&&typeof t==`string`&&(e.content=t);e.activeBanners=t.banners||[],t.isHtml&&(e.mimeType=`text/html`,e.hasHtml=!0,e.content=jn(e.content,{mailbox:n,messageUid:e.message?.UID,allowRemoteResources:e.allowRemoteResources,messageStructure:e.message?.BodyStructure,onRemoteResourceBlocked:()=>{e.hasRemoteResources=!0,String(e.message.UID)===String(this.message?.UID)&&(this.hasRemoteResources=!0)}}))}}Rt.set(n,t.UID.toString(),r,{Message:o.Message,Part:o.Part,Attachments:o.Attachments,RawHtml:s,RawText:c,HasHTML:e.hasHtml,HasText:e.hasText})}catch(t){S.error(`Failed to fetch message:`,t),e.content=`Error loading message.`}finally{e.loading=!1,!this._deferPropertySync&&String(e.message.UID)===String(this.message?.UID)&&(this.content=e.content,this.mimeType=e.mimeType,this.rawMessageHtml=e.rawMessageHtml,this.attachments=e.attachments,this.hasHtml=e.hasHtml,this.hasText=e.hasText,this.activeBanners=e.activeBanners,this.allowRemoteResources=e.allowRemoteResources,this.hasRemoteResources=e.hasRemoteResources,this.loading=!1,this.message={...this.message,...e.message}),this.updateThreadItemReference(e)}}getSentMailboxName(){if(this.mailboxes&&Array.isArray(this.mailboxes)){for(let e of this.mailboxes){let t=e.Name||e.Mailbox;if(t&&(e.Attrs||[]).some(e=>typeof e==`string`&&(e.toLowerCase()===`\\sent`||e.toLowerCase()===`\\\\sent`)))return t}let e=[`sent`,`sent messages`,`sent items`,`sent-mail`];for(let t of this.mailboxes){let n=t.Name||t.Mailbox;if(n&&e.includes(n.toLowerCase()))return n}}return ze}async toggleItemExpansion(e){e.expanded=!e.expanded,this.updateThreadItemReference(e),e.expanded&&!e.content&&!e.loading&&(e.loading=!0,this.updateThreadItemReference(e),await this.fetchItemBody(e))}loadRemoteResourcesForItem(e){e.allowRemoteResources=!0,e.rawMessageHtml&&(e.content=jn(e.rawMessageHtml,{mailbox:e.mailbox,messageUid:e.message?.UID,allowRemoteResources:e.allowRemoteResources,messageStructure:e.message?.BodyStructure,onRemoteResourceBlocked:()=>{e.hasRemoteResources=!0}}),e===this.threadItems[0]&&(this.content=e.content,this.allowRemoteResources=!0),this.updateThreadItemReference(e))}async toggleItemStar(e){if(!e.message)return;let t=e.message.Flags?.includes(L),n=t?`remove`:`add`;t?e.message.Flags=e.message.Flags.filter(e=>e!==L):e.message.Flags=[...e.message.Flags||[],L],this.updateThreadItemReference(e),this.dispatchEvent(new CustomEvent(`message-flags-changed`,{detail:{uid:String(e.message.UID),flag:L,action:n},bubbles:!0,composed:!0}));try{await R.setFlag(e.mailbox,[String(e.message.UID)],[`\\Flagged`],n)?String(e.message.UID)===String(this.message?.UID)&&(this.message.Flags=e.message.Flags,this.requestUpdate()):(t?e.message.Flags=[...e.message.Flags||[],L]:e.message.Flags=e.message.Flags.filter(e=>e!==L),this.updateThreadItemReference(e),this.dispatchEvent(new CustomEvent(`message-flags-changed`,{detail:{uid:String(e.message.UID),flag:L,action:t?`add`:`remove`},bubbles:!0,composed:!0})))}catch(n){S.error(`Failed to toggle star for thread item`,n),t?e.message.Flags=[...e.message.Flags||[],L]:e.message.Flags=e.message.Flags.filter(e=>e!==L),this.updateThreadItemReference(e),this.dispatchEvent(new CustomEvent(`message-flags-changed`,{detail:{uid:String(e.message.UID),flag:L,action:t?`add`:`remove`},bubbles:!0,composed:!0}))}}async deleteItem(e){if(e.message&&confirm(this.i18nStore?.t(`messageReader.deleteConfirmSingle`)||`Are you sure you want to permanently delete this message?`))try{if(await R.deleteMessages(e.mailbox,[String(e.message.UID)])){let t=String(e.message.UID),n=this.threadItems.length>0&&String(this.threadItems[0].message?.UID)===t;this.threadItems=this.threadItems.filter(e=>String(e.message?.UID)!==t),this.requestUpdate(),n&&this.dispatchEvent(new CustomEvent(`action`,{detail:{action:`delete`}}))}}catch(e){S.error(`Failed to delete thread item`,e)}}async _handleActionForItem(e,t){if(e===`reply`||e===`replyAll`||e===`forward`){let n=``;if(t.mimeType===`text/plain`)n=t.content;else{try{let e=await E(`/mailboxes/${D(t.mailbox)}/messages/${t.message.UID}?view=text`);if(e.ok){let t=await e.json();t.Part&&t.RawText&&(n=t.RawText)}}catch(e){S.error(`Failed to fetch text body for quote`,e)}!n&&t.rawMessageHtml&&(n=In(t.rawMessageHtml))}let r=this.settingsStore?.getState()?.dateFormat||`YYYY-MM-DD`,i=String(this.settingsStore?.getState()?.hourFormat||`12`),{subject:a,to:o,cc:s,quotedText:c,quotedHtml:l}=Nn(e,t.message,n,t.rawMessageHtml,t.hasHtml,r,i),u=e===`forward`?t.attachments.map(e=>({name:e.Filename||`attachment`,size:e.Size||0,type:e.MIMEType||`application/octet-stream`,partPath:e.Path?e.Path.join(`.`):void 0})):[],d=e===`reply`||e===`replyAll`?t.message.Envelope?.MessageID||t.message.Envelope?.MessageId:void 0;this.composeStore.openComposer({subject:a,to:o,cc:s,text:c,html:l,format:this.settingsStore?.getState()?.composeFormat||`html`,attachments:u,inReplyTo:d});return}if(e===`showPlaintext`){this.localPreferredView=`text`,this.fetchItemBody(t);return}if(e===`showHtml`){this.localPreferredView=`html`,this.fetchItemBody(t);return}if(e===`print`){let e=t.allowRemoteResources?`&remote=1`:``;window.open(`#/print?mailbox=`+encodeURIComponent(t.mailbox)+`&uid=`+t.message.UID+e,`_blank`);return}}applyThemeToIframe(e){Pn(e,this.settingsStore?.getState()?.themeIframeContent??!1)}applyThemeToAllIframes(){let e=this.shadowRoot?.querySelectorAll(`iframe.reader-iframe`);e&&e.forEach(e=>this.applyThemeToIframe(e))}onIframeLoad(e){let t=e.target;Fn(t,this.settingsStore?.getState()?.themeIframeContent??!1)}async _handleEditDraft(e){let t=e&&!(e instanceof Event),n=t?e.message:this.message,r=t?e.mailbox:this.mailbox;if(!n)return;t&&e&&!e.content&&!e.loading&&(e.loading=!0,this.updateThreadItemReference(e),await this.fetchItemBody(e));let i=t&&e?e.content:this.content,a=t&&e?e.mimeType:this.mimeType,o=t&&e?e.rawMessageHtml:this.rawMessageHtml,s=t&&e?e.attachments:this.attachments,c=``;if(a===`text/plain`)c=i;else{try{let e=await E(`/mailboxes/${D(r)}/messages/${n.UID}?view=text`);if(e.ok){let t=await e.json();t.Part&&t.RawText&&(c=t.RawText)}}catch(e){S.error(`Failed to fetch text body for draft`,e)}c||=In(o)}let l=(s||[]).map(e=>({name:e.Filename||`attachment`,size:e.Size||0,type:e.MIMEType||`application/octet-stream`,partPath:e.Path?e.Path.join(`.`):void 0})),u=e=>e?e.map(e=>e.Name?`${e.Name} <${e.Mailbox}@${e.Host}>`:`${e.Mailbox}@${e.Host}`):[];this.composeStore.openComposer({draftUid:n.UID.toString(),draftMailbox:r,subject:n.Envelope?.Subject||``,to:u(n.Envelope?.To),cc:u(n.Envelope?.Cc),bcc:u(n.Envelope?.Bcc),text:c,html:o,format:this.settingsStore?.getState()?.composeFormat||`html`,attachments:l})}renderThreadCard(e){return s`
    ...
    `}render(){let e=this.selectedUids&&this.selectedUids.size>0,t=this.settingsStore?.getState()?.enableThreading??!0;if(!this.message&&!e)return s`
      ...
      <alps-toolbar class="toolbar" ?scrolled=${this.isScrolled}>
        ...
        `:``}
        <alps-icon-btn title=${this.message?.Flags?.includes(`\\Draft`)||b?this.i18nStore?.t(`messageReader.discardDraft`):this.i18nStore?.t(`messageReader.delete`)} @click=${()=>this._handleAction(`delete`)} icon="trash"></alps-icon-btn>
        ...
        <div class="toolbar-separator mobile-only"></div>
          ...
          ${e?``:s`
            ${this.message?.Flags?.includes(`\\Draft`)||b?s`
      ...
      `:``}
      `}
    `}};k([g({context:T})],W.prototype,`settingsStore`,void 0),k([g({context:w})],W.prototype,`i18nStore`,void 0),k([g({context:cn})],W.prototype,`composeStore`,void 0),k([a()],W.prototype,`localPreferredView`,void 0),k([a()],W.prototype,`hasHtml`,void 0),k([a()],W.prototype,`hasText`,void 0),k([o({type:String})],W.prototype,`mailbox`,void 0),k([o({type:Object})],W.prototype,`message`,void 0),k([o({type:Array})],W.prototype,`messages`,void 0),k([o({type:Object})],W.prototype,`selectedUids`,void 0),k([o({type:Boolean})],W.prototype,`allSelectedStarred`,void 0),k([o({type:Boolean})],W.prototype,`allSelectedUnread`,void 0),k([o({type:Array})],W.prototype,`commonTags`,void 0),k([o({type:Boolean})],W.prototype,`bulkProcessing`,void 0),k([o({type:String})],W.prototype,`layoutMode`,void 0),k([o({type:Array})],W.prototype,`mailboxes`,void 0),k([a()],W.prototype,`content`,void 0),k([a()],W.prototype,`mimeType`,void 0),k([a()],W.prototype,`loading`,void 0),k([a()],W.prototype,`activeBanners`,void 0),k([a()],W.prototype,`attachments`,void 0),k([a()],W.prototype,`allowRemoteResources`,void 0),k([a()],W.prototype,`hasRemoteResources`,void 0),k([a()],W.prototype,`rawMessageHtml`,void 0),k([a()],W.prototype,`isScrolled`,void 0),k([a()],W.prototype,`threadItems`,void 0),k([a()],W.prototype,`_isThread`,void 0),W=k([m(`alps-message-reader`)],W);var zn=1e4,Bn=250,Vn=150,Hn=500,Un=64,Wn=120,Gn=380,Kn=300,qn=57,Jn=150,Yn=250,G=class extends d{constructor(...e){super(...e),this.showDeleteConfirm=!1,this.pendingDeleteDetails=null,this.markReadTimer=null,this.notificationSound=new Audio(`/assets/notify.wav`),this.notificationTarget=``,this.audioUnlocked=!1,this.unlockAudio=()=>{this.audioUnlocked||(this.notificationSound.muted=!0,this.notificationSound.play().then(()=>{this.notificationSound.pause(),this.notificationSound.currentTime=0,this.audioUnlocked=!0}).catch(()=>{}).finally(()=>{this.notificationSound.muted=!1}),document.removeEventListener(`click`,this.unlockAudio),document.removeEventListener(`keydown`,this.unlockAudio))},this.mailboxes=[],this.messages=[],this.currentMailbox=`-`,this.loadingMessages=!0,this.showInitialLoader=!window.alpsAppLoaded,this.selectedMessage=null,this.selectedUids=new Set,this.layoutMode=`vertical`,this.filterQuery=``,this.expandedFolders=new Set,this.username=``,this.currentPage=0,this.totalMessages=0,this.messagesPerPage=50,this.resizerPositionX=Bn+Math.max(Gn,(window.innerWidth-Bn)*.4),this.listHeight=Math.max(Yn,(window.innerHeight-qn)*.4),this.isSidebarDragging=!1,this.isPaneDragging=!1,this.sidebarWidth=Bn,this.isSidebarHovered=!1,this.hoverTimeout=null,this.densityMode=`compact`,this.isSyncing=!1,this.sidebarCollapsed=!1,this.suppressSidebarHover=!1,this.sortOrder=`desc`,this.listScrolled=!1,this.targetUid=null,this.isMobile=window.innerWidth<=768,this.mobileSidebarOpen=!1,this.bulkProcessing=!1,this.computedMinListWidth=Gn,this._mql=window.matchMedia(`(max-width: 768px)`),this._handleMediaQuery=e=>{this.isMobile=e.matches,this.isMobile||(this.mobileSidebarOpen=!1)},this.handleDraftAutosaved=e=>{let{oldUid:t,newUid:n,mailbox:r,subject:i,hasAttachments:a,size:o}=e.detail;if(this.currentMailbox===r&&this.messages){let e=Number(n),r=!1;if(t){let n=this.messages.findIndex(e=>String(e.UID)===String(t));if(n!==-1){let s=[...this.messages];if(s[n]={...s[n],UID:e,Size:o||s[n].Size,RFC822Size:o||s[n].RFC822Size,HasAttachments:a,_isAutosaveUpdate:!0,Envelope:{...s[n].Envelope,Subject:i||s[n].Envelope?.Subject||`(No subject)`}},this.messages=s,r=!0,this.selectedMessage&&String(this.selectedMessage.UID)===String(t)){this.selectedMessage=s[n],this.targetUid=String(e);let r=window.location.hash;r.includes(`/${t}`)?r=r.replace(`/${t}`,`/${e}`):r.includes(`uid=${t}`)&&(r=r.replace(`uid=${t}`,`uid=${e}`)),window.history.replaceState(null,``,r)}}else for(let n=0;n<this.messages.length;n++){let s=this.messages[n];if(s.SubMessages){let c=s.SubMessages.findIndex(e=>String(e.UID)===String(t));if(c!==-1){let l=[...s.SubMessages];l[c]={...l[c],UID:e,Size:o||l[c].Size,RFC822Size:o||l[c].RFC822Size,HasAttachments:a,_isAutosaveUpdate:!0,Envelope:{...l[c].Envelope,Subject:i||l[c].Envelope?.Subject||`(No subject)`}};let u=[...this.messages];if(u[n]={...s,SubMessages:l},this.messages=u,r=!0,this.selectedMessage&&String(this.selectedMessage.UID)===String(t)){this.selectedMessage=l[c],this.targetUid=String(e);let n=window.location.hash;n.includes(`/${t}`)?n=n.replace(`/${t}`,`/${e}`):n.includes(`uid=${t}`)&&(n=n.replace(`uid=${t}`,`uid=${e}`)),window.history.replaceState(null,``,n)}break}}}}if(!r){let r=this.settingsStore?.getState().name||this.username,s=(this.username||``).split(`@`),c=s[0]||``,l=s[1]||``,u={UID:e,Size:o||0,RFC822Size:o||0,HasAttachments:a,Flags:[I,Vt],_isAutosaveUpdate:!0,Envelope:{Subject:i||`(No subject)`,Date:new Date().toISOString(),From:[{Name:r,Mailbox:c,Host:l}]}},d=this.messages.filter(e=>String(e.UID)!==String(t)&&String(e.UID)!==String(n));this.messages=[u,...d]}}},this._handleSettingsChange=()=>{this._syncSettings()},this._handleI18nChange=()=>{this.requestUpdate()},this.handleSyncStart=e=>{let t=e.detail;this.isSyncing=!0,t.background||(this.loadingMessages=!0)},this.handleSyncSuccess=e=>{this.isSyncing=!1;let{data:t,background:n}=e.detail;t.Username&&(this.username=t.Username,this.settingsStore.getState().loginUsername!==t.Username&&this.settingsStore.updateSettings({loginUsername:t.Username}));let r=this.mailboxes.length===0,i=!1,a=!1,o=0;if(t.Mailboxes){for(let e of t.Mailboxes){let t=e.Name||e.Mailbox,s=this.mailboxes.find(e=>(e.Name||e.Mailbox)===t),c=s?s.Total:void 0;c!==void 0&&e.Total!==void 0&&e.Total>c&&!r&&n&&(i=!0,qe(e)===`inbox`&&(a=!0,o+=e.Total-c))}this.mailboxes=t.Mailboxes}if(i&&this.settingsStore.getState().soundNotifications&&(this.notificationSound.currentTime=0,this.notificationSound.play().catch(e=>{e.name!==`NotAllowedError`&&S.error(`Failed to play sound notification:`,e)})),a&&this.settingsStore.getState().desktopNotifications&&`Notification`in window&&Notification.permission===`granted`){let e=this.i18nStore?.t(`mailboxPage.newMessages`),t=o===1?this.i18nStore?.t(`mailboxPage.newMessagesSingleBody`):(this.i18nStore?.t(`mailboxPage.newMessagesMultiBody`)).replace(`{count}`,String(o));try{let n=new Notification(e,{body:t,icon:`/apple-touch-icon.png`,tag:`alps-new-message`});n.onclick=()=>{window.focus(),n.close(),this.notificationTarget!==``&&this.currentMailbox!==this.notificationTarget?this.updateUrl(this.notificationTarget,0,null):(this.currentPage=0,F.fetch(this.currentMailbox,0,this.filterQuery,!1)),this.notificationTarget=``}}catch(e){S.error(`Failed to show desktop notification:`,e)}}if(a&&this.notificationTarget!==``&&this.currentMailbox!==this.notificationTarget){let e=this.notificationTarget;this.notificationTarget=``,this.showGlobalToast(this.i18nStore?.t(`mailboxPage.newMessagesInInbox`),this.i18nStore?.t(`mailboxPage.open`),()=>{this.updateUrl(e,0,null)},5e3)}if(n&&this.currentPage>0)t.Total!==void 0&&t.Total!==this.totalMessages&&this.showGlobalToast(this.i18nStore?.t(`mailboxPage.newMessagesAvailable`),this.i18nStore?.t(`mailboxPage.refresh`),()=>{this.currentPage=0,F.fetch(this.currentMailbox,this.currentPage,this.filterQuery,!1)});else if(t.Page!==void 0&&(this.currentPage=t.Page),t.Total!==void 0&&(this.totalMessages=t.Total),t.MessagesPerPage!==void 0&&(this.messagesPerPage=t.MessagesPerPage),t.Messages){if(this.messages=t.Messages,this.selectedMessage){let e=this.messages.find(e=>String(e.UID)===String(this.selectedMessage.UID));e&&e.Flags&&(this.selectedMessage={...this.selectedMessage,Flags:e.Flags})}}else this.messages=[];n||(this.loadingMessages=!1,this.applyTargetUid(),this.showInitialLoader&&setTimeout(()=>{this.showInitialLoader=!1,window.alpsAppLoaded=!0},100))},this.handleSyncError=e=>{this.isSyncing=!1;let{background:t}=e.detail;t||(this.loadingMessages=!1)},this.handleMailboxNotFound=()=>{this.showGlobalToast(this.i18nStore.t(`mailboxPage.mailboxNotFound`),``,void 0,3e3),this.updateUrl(`-`,0,null,null)},this.handleHashChange=()=>{let e=this.currentMailbox,t=this.currentPage,n=this.targetUid,r=this.filterQuery;this.extractMailboxFromHash(),e!==this.currentMailbox||t!==this.currentPage||r!==this.filterQuery?(e===this.currentMailbox?r!==this.filterQuery&&(this.loadingMessages=!0,this.currentPage=0):(this.selectedMessage=null,this.currentPage=0,this.selectedUids=new Set,this.loadingMessages=!0),F.fetch(this.currentMailbox,this.currentPage,this.filterQuery,!1)):n!==this.targetUid&&this.applyTargetUid()},this.startResize=e=>{e.preventDefault(),this.isPaneDragging=!0,this.updateComputedMinWidth();let t=e=>{if(this.layoutMode===`vertical`){let t=this.sidebarCollapsed?Un:this.sidebarWidth,n=Math.max(t+this.computedMinListWidth,Math.min(e.clientX,window.innerWidth-Kn));this.resizerPositionX=n}else this.layoutMode===`horizontal`&&(this.listHeight=Math.max(Jn,Math.min(e.clientY-qn,window.innerHeight-Jn)))},n=()=>{this.isPaneDragging=!1,window.removeEventListener(`mousemove`,t),window.removeEventListener(`mouseup`,n)};window.addEventListener(`mousemove`,t),window.addEventListener(`mouseup`,n)}}static{this.styles=n`
    :host {
      display: flex;
      flex-direction: column;
      height: 100vh;
    ...
    .layout-vertical .message-list-pane { width: ${Gn}px; flex-shrink: 0; border-right: 1px solid var(--border-color); }
    ...
    `}updateComputedMinWidth(){let e=Gn,t=this.shadowRoot?.querySelector(`.message-list-pane alps-message-list`);if(t){let n=t.shadowRoot?.querySelector(`.list-header`);if(n){let t=at(n);e=Math.max(Gn,t+2)}}if(e!==this.computedMinListWidth){this.computedMinListWidth=e;let t=this.sidebarCollapsed&&!this.isMobile?Un:this.sidebarWidth;this.resizerPositionX-t<e&&(this.resizerPositionX=t+e)}}showGlobalToast(e,t=``,n,r=3e3){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:e,actionLabel:t,actionFn:n,duration:r}}))}get effectiveListWidth(){let e=this.sidebarCollapsed&&!this.isMobile?Un:this.sidebarWidth;return Math.max(this.computedMinListWidth,this.resizerPositionX-e)}get allSelectedStarred(){if(this.selectedUids.size===0)return!1;for(let e of this.selectedUids){let t=this.messages.find(t=>String(t.UID)===e);if(!t||!t.Flags?.includes(`\\Flagged`))return!1}return!0}get commonSelectedTags(){return this.selectedUids.size===0?[]:[`$label1`,`$label2`,`$label3`,`$label4`,`$label5`].filter(e=>{for(let t of this.selectedUids){let n=this.messages.find(e=>String(e.UID)===t);if(!n||!n.Flags?.some(t=>t.toLowerCase()===e.toLowerCase()))return!1}return!0})}get allSelectedUnread(){if(this.selectedUids.size===0)return!1;for(let e of this.selectedUids){let t=this.messages.find(t=>String(t.UID)===e);if(t&&t.Flags?.includes(`\\Seen`))return!1}return!0}connectedCallback(){super.connectedCallback(),this.extractMailboxFromHash(),window.addEventListener(`hashchange`,this.handleHashChange),document.addEventListener(`click`,this.unlockAudio),document.addEventListener(`keydown`,this.unlockAudio),this._mql.addEventListener(`change`,this._handleMediaQuery),this._handleMediaQuery(this._mql),this.settingsStore.addEventListener(`change`,this._handleSettingsChange),this._syncSettings(),F.addEventListener(`sync-start`,this.handleSyncStart),F.addEventListener(`sync-success`,this.handleSyncSuccess),F.addEventListener(`sync-error`,this.handleSyncError),F.addEventListener(`mailbox-not-found`,this.handleMailboxNotFound),window.addEventListener(`draft-autosaved`,this.handleDraftAutosaved),F.fetch(this.currentMailbox,this.currentPage,this.filterQuery,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`hashchange`,this.handleHashChange),this._mql.removeEventListener(`change`,this._handleMediaQuery),document.removeEventListener(`click`,this.unlockAudio),document.removeEventListener(`keydown`,this.unlockAudio),this.settingsStore.removeEventListener(`change`,this._handleSettingsChange),this.i18nStore?.removeEventListener(`change`,this._handleI18nChange),F.removeEventListener(`sync-start`,this.handleSyncStart),F.removeEventListener(`sync-success`,this.handleSyncSuccess),F.removeEventListener(`sync-error`,this.handleSyncError),F.removeEventListener(`mailbox-not-found`,this.handleMailboxNotFound),window.removeEventListener(`draft-autosaved`,this.handleDraftAutosaved),F.stop()}updated(e){super.updated(e),(e.has(`sidebarCollapsed`)||e.has(`layoutMode`)||e.has(`currentMailbox`)||e.has(`isMobile`)||e.has(`mailboxes`))&&setTimeout(()=>this.updateComputedMinWidth(),0)}_syncSettings(){let e=this.settingsStore.getState();this.layoutMode=e.layoutMode,this.densityMode=e.densityMode,this.sortOrder=e.sortOrder||`desc`,this.sidebarCollapsed!==e.sidebarCollapsed&&(this.sidebarCollapsed=e.sidebarCollapsed),e.messagesPerPage&&e.messagesPerPage>0&&(this.messagesPerPage=e.messagesPerPage),e.checkMailInterval!==void 0&&F.start(e.checkMailInterval)}openFolderPrompt(){let e=this.shadowRoot?.querySelector(`alps-folder-list`);e&&typeof e.triggerCreateFolder==`function`&&e.triggerCreateFolder()}updateUrl(e,t,n,r=this.filterQuery){let i=`#/mailbox/${encodeURIComponent(e)}`,a=new URLSearchParams;t>0&&a.set(`p`,t.toString()),n&&a.set(`uid`,n),r&&a.set(`q`,r);let o=a.toString();o&&(i+=`?`+o),window.location.hash=i}extractMailboxFromHash(){let e=window.location.hash;if(e.startsWith(`#/mailbox/`)){let t=e.substring(10),n=t.indexOf(`?`),r=``;n!==-1&&(r=t.substring(n+1),t=t.substring(0,n));let i=t.split(`/`);this.currentMailbox=decodeURIComponent(i[0]);let a=new URLSearchParams(r);i.length>1&&i[1]?this.targetUid=i[1]:this.targetUid=a.get(`uid`)||null;let o=a.get(`p`);o?this.currentPage=parseInt(o,10)||0:this.currentPage=0,this.filterQuery=a.get(`q`)||``}else this.currentMailbox=`-`,this.targetUid=null,this.currentPage=0}async applyTargetUid(){if(!this.targetUid){this.markReadTimer&&=(clearTimeout(this.markReadTimer),null),this.selectedMessage=null;return}let e=this.targetUid,t=this.messages.find(t=>String(t.UID)===e);if(!t&&this.messages.length>0)try{let n=await E(`/mailboxes/${D(this.currentMailbox)}/messages/${e}`);if(n.ok){let e=await n.json();e.Message&&(t=e.Message)}}catch(e){S.error(`Failed to fetch shifted message:`,e)}this.targetUid===e&&(t?this.selectedMessage?.UID!==t.UID&&(this.selectedMessage=t,this.layoutMode===`full`&&this.expandedFolders.clear(),this._scheduleMarkAsRead(t)):this.messages.length>0&&(this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null)))}async selectMessage(e){this.updateUrl(this.currentMailbox,this.currentPage,e.UID)}_scheduleMarkAsRead(e){if(this.markReadTimer&&=(clearTimeout(this.markReadTimer),null),e.Flags?.includes(`\\Seen`))return;let t=this.settingsStore?.getState().markReadTimeout??0;t<0||(t===0?this._doMarkAsRead(e):this.markReadTimer=setTimeout(()=>{this._doMarkAsRead(e)},t*1e3))}updateLocalMessageFlags(e,t,n){let r=!1,i=[...this.messages];for(let a=0;a<i.length;a++){let o=i[a];if(e.includes(String(o.UID))){let e=o.Flags&&o.Flags.includes(t);n===`add`&&!e?(i[a]={...o,Flags:[...o.Flags||[],t]},r=!0):n===`remove`&&e&&(i[a]={...o,Flags:o.Flags.filter(e=>e!==t)},r=!0)}}if(r&&(this.messages=i,this.selectedMessage&&e.includes(String(this.selectedMessage.UID)))){let e=this.selectedMessage.Flags&&this.selectedMessage.Flags.includes(t);n===`add`&&!e?this.selectedMessage.Flags=[...this.selectedMessage.Flags||[],t]:n===`remove`&&e&&(this.selectedMessage.Flags=this.selectedMessage.Flags.filter(e=>e!==t)),this.selectedMessage={...this.selectedMessage}}}async _handleListToggleStar(e){let t=e.detail.message,n=t.Flags&&t.Flags.includes(`\\Flagged`),r=n?`remove`:`add`;this.updateLocalMessageFlags([String(t.UID)],L,r);try{await R.setFlag(this.currentMailbox,[String(t.UID)],[`\\Flagged`],r)||this.updateLocalMessageFlags([String(t.UID)],L,n?`add`:`remove`)}catch{this.updateLocalMessageFlags([String(t.UID)],L,n?`add`:`remove`)}}async _doMarkAsRead(e){if(this.selectedMessage?.UID===e.UID)this.selectedMessage=await R.markAsRead(this.currentMailbox,e),this.updateLocalMessageFlags([String(this.selectedMessage.UID)],I,`add`);else{let t=await R.markAsRead(this.currentMailbox,e);t&&t.UID&&this.updateLocalMessageFlags([String(t.UID)],I,`add`)}}async _handleReaderAction(e){let t=e.detail.action,n=this.selectedUids&&this.selectedUids.size>0,r=n?Array.from(this.selectedUids):[];if(!(!n&&!this.selectedMessage?.UID)){n&&(this.bulkProcessing=!0);try{let i=this.selectedMessage,a=this.currentMailbox;if(t===`star`)if(n){let e=this.allSelectedStarred?`remove`:`add`;await R.setFlag(this.currentMailbox,r,[L],e),this.updateLocalMessageFlags(r,L,e)}else this.selectedMessage=await R.toggleStar(this.currentMailbox,this.selectedMessage),this.updateLocalMessageFlags([String(this.selectedMessage.UID)],L,this.selectedMessage.Flags?.includes(`\\Flagged`)?`add`:`remove`);else if(t===`addTag`||t===`removeTag`){let a=e.detail.tags||(e.detail.folder?[e.detail.folder]:[]);if(!a||a.length===0)return;let o=t===`addTag`?`add`:`remove`;if(n){await R.setFlag(this.currentMailbox,r,a,o);for(let e of a)this.updateLocalMessageFlags(r,e,o)}else{await R.setFlag(this.currentMailbox,[String(i.UID)],a,o);for(let e of a)this.updateLocalMessageFlags([String(i.UID)],e,o)}this.requestUpdate()}else if(t===`markUnread`)if(n){let e=this.allSelectedUnread?`add`:`remove`;await R.setFlag(this.currentMailbox,r,[I],e),this.updateLocalMessageFlags(r,I,e)}else !i?.Flags||!i.Flags.includes(`\\Seen`)?(this.selectedMessage=await R.markAsRead(this.currentMailbox,i),this.updateLocalMessageFlags([String(this.selectedMessage.UID)],I,`add`)):await R.markAsUnread(this.currentMailbox,i)&&(this.updateLocalMessageFlags([String(i.UID)],I,`remove`),this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null));else if(t===`delete`||t===`archive`||t===`reportSpam`||t===`notSpam`){let e=Je(this.currentMailbox,this.mailboxes),o=e===`trash`,s=e===`drafts`,c=e===`junk`,l={success:!1},u=Xe(`trash`,this.currentMailbox,this.mailboxes,We);if(t===`archive`&&(u=Xe(`archive`,this.currentMailbox,this.mailboxes,Be)),t===`reportSpam`&&(u=Xe(`junk`,this.currentMailbox,this.mailboxes,Ue)),t===`notSpam`&&(u=Xe(`inbox`,this.currentMailbox,this.mailboxes,Le)),t===`delete`&&(o||s||c)){this.pendingDeleteDetails={isBulk:n,uidsArray:r,currentMsgUid:i?.UID,isTrash:o,isDrafts:s,isSpam:c},this.showDeleteConfirm=!0;return}else l=n?await R.moveMessages(this.currentMailbox,r,u):await R.moveMessages(this.currentMailbox,[String(i.UID)],u);if(l.success){n?(this.selectedUids=new Set,this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null),this.requestUpdate()):(this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null));let e=``,o;if(e=t===`archive`?n?this.i18nStore?.t(`toast.messagesMovedToArchive`,{count:r.length}):this.i18nStore?.t(`toast.messageMovedToArchive`):t===`reportSpam`?n?this.i18nStore?.t(`toast.messagesMovedToSpam`,{count:r.length}):this.i18nStore?.t(`toast.messageMovedToSpam`):t===`notSpam`?n?this.i18nStore?.t(`toast.messagesMovedToInbox`,{count:r.length}):this.i18nStore?.t(`toast.messageMovedToInbox`):n?this.i18nStore?.t(`toast.messagesMovedToTrash`,{count:r.length}):this.i18nStore?.t(`toast.messageMovedToTrash`),n&&l.uidMapping){let e=Object.values(l.uidMapping);o=async()=>{try{let t=await R.moveMessages(u,e,a);if(t.success&&this.currentMailbox===a&&t.uidMapping){let e=new Set(this.selectedUids);Object.values(t.uidMapping).forEach(t=>e.add(t)),this.selectedUids=e,this.requestUpdate()}}catch(e){S.error(`Undo failed`,e)}}}else if(!n&&l.uidMapping?.[String(i.UID)]){let e={UID:l.uidMapping[String(i.UID)]};o=async()=>{try{let t=await R.moveMessages(u,[String(e.UID)],a);if(t.success){let n=this.currentMailbox===a?this.currentPage:0;t.uidMapping?.[String(e.UID)]?this.updateUrl(a,n,t.uidMapping[String(e.UID)]):this.updateUrl(a,n,null)}}catch(e){S.error(`Undo failed`,e)}}}this.showGlobalToast(e,o?this.i18nStore?.t(`mailboxPage.undo`):``,o,zn)}}else if(t===`moveTo`||t===`copyTo`){let o=e.detail.folder;if(!o)return;let s=t===`moveTo`,c={success:!1};if(c=s?n?await R.moveMessages(this.currentMailbox,r,o):await R.moveMessages(this.currentMailbox,[String(i.UID)],o):n?await R.copyMessages(this.currentMailbox,r,o):await R.copyMessages(this.currentMailbox,[String(i.UID)],o),c.success){s&&(n?(this.selectedUids=new Set,this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null),this.requestUpdate()):(this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null)));let e=s?n?this.i18nStore?.t(`toast.messagesMovedToFolder`,{count:r.length,folder:o}):this.i18nStore?.t(`toast.messageMovedToFolder`,{folder:o}):n?this.i18nStore?.t(`toast.messagesCopiedToFolder`,{count:r.length,folder:o}):this.i18nStore?.t(`toast.messageCopiedToFolder`,{folder:o}),t;if(n&&s&&c.uidMapping){let e=Object.values(c.uidMapping);t=async()=>{try{let t=await R.moveMessages(o,e,a);if(t.success&&this.currentMailbox===a&&t.uidMapping){let e=new Set(this.selectedUids);Object.values(t.uidMapping).forEach(t=>e.add(t)),this.selectedUids=e,this.requestUpdate()}}catch(e){S.error(`Undo failed`,e)}}}else if(!n&&s&&c.uidMapping?.[String(i.UID)]){let e={UID:c.uidMapping[String(i.UID)]};t=async()=>{try{let t=await R.moveMessages(o,[String(e.UID)],a);if(t.success){let n=this.currentMailbox===a?this.currentPage:0;t.uidMapping?.[String(e.UID)]?this.updateUrl(a,n,t.uidMapping[String(e.UID)]):this.updateUrl(a,n,null)}}catch(e){S.error(`Undo failed`,e)}}}this.showGlobalToast(e,t?this.i18nStore?.t(`mailboxPage.undo`):``,t,zn)}}else if(t===`downloadMessage`&&!n){let e=i.UID,t=`/mailboxes/${D(this.currentMailbox)}/messages/${e}/raw`,n=document.createElement(`a`);n.href=t,n.download=``,document.body.appendChild(n),n.click(),document.body.removeChild(n)}else if(t===`showOriginal`&&!n){let e=`#/original?mailbox=${encodeURIComponent(this.currentMailbox)}&uid=${i.UID}`;window.open(e,`_blank`)}}finally{n&&(this.bulkProcessing=!1)}}}async _confirmDelete(){this.showDeleteConfirm=!1;let e=this.pendingDeleteDetails;if(this.pendingDeleteDetails=null,!e)return;let{isBulk:t,uidsArray:n,currentMsgUid:r,isDrafts:i}=e;t&&(this.bulkProcessing=!0);try{let e=!1;if(e=t?await R.deleteMessages(this.currentMailbox,n):await R.deleteMessages(this.currentMailbox,[String(r)]),e){t?(this.selectedUids=new Set,this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null),this.requestUpdate()):(this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null));let e=``;e=i?t?this.i18nStore?.t(`toast.draftsDiscarded`,{count:n.length}):this.i18nStore?.t(`toast.draftDiscarded`):t?this.i18nStore?.t(`toast.messagesPermanentlyDeleted`,{count:n.length}):this.i18nStore?.t(`toast.messagePermanentlyDeleted`),this.showGlobalToast(e,``,void 0,zn)}}finally{t&&(this.bulkProcessing=!1)}}_cancelDelete(){this.showDeleteConfirm=!1,this.pendingDeleteDetails=null}toggleFolder(e,t){t&&(t.stopPropagation(),t.preventDefault());let n=new Set(this.expandedFolders);n.has(e)?n.delete(e):n.add(e),this.expandedFolders=n}render(){let e=this.isMobile?`full`:this.layoutMode,t=e===`full`&&this.selectedMessage!==null;return s`
      ...
      <div class="app-container layout-${e} ${t?`reading`:``} ${this.isPaneDragging||this.isSidebarDragging?`dragging`:``} ${this.sidebarCollapsed&&!this.isMobile?`collapsed`:``} ${this.isMobile?`mobile-view`:``} ${this.suppressSidebarHover?`suppress-sidebar-hover`:``}" style="${!this.sidebarCollapsed&&!this.isMobile?`--sidebar-width: ${this.sidebarWidth}px;`:``}">
        <alps-sidebar 
          ...
          .collapsed=${this.sidebarCollapsed&&!this.isMobile}
          .width=${this.sidebarWidth}
          @sidebar-resize=${e=>{let t=e.detail.newWidth;t<Wn?(this.sidebarCollapsed||this.settingsStore.updateSettings({sidebarCollapsed:!0}),this.sidebarWidth=Bn):(this.sidebarCollapsed&&this.settingsStore.updateSettings({sidebarCollapsed:!1}),this.sidebarWidth=Math.min(Math.max(t,Vn),Hn),this.resizerPositionX=Math.max(this.resizerPositionX,this.sidebarWidth+Gn))}}
          @drag-start=${()=>this.isSidebarDragging=!0}
          @drag-end=${()=>this.isSidebarDragging=!1}
  ...
  `]}updated(e){(e.has(`contact`)||e.has(`isEditing`))&&this.contact&&this.isEditing&&(!this.editForm||this.editForm.path!==this.contact.path)&&(this.editForm={...this.contact},this.isDirty=!1,Array.isArray(this.editForm.categories)&&(this.editForm.categories=this.editForm.categories.join(`, `)))}debouncedSave(){this.saveTimeout&&clearTimeout(this.saveTimeout),this.saveTimeout=setTimeout(()=>{this.handleSave()},500)}handleInput(e,t){this.editForm={...this.editForm,[e]:t},this.isDirty=!0,this.debouncedSave()}handleSave(){this.dispatchEvent(new CustomEvent(`save`,{detail:this.editForm,bubbles:!0,composed:!0}))}renderDetailRow(e,t){if(!t)return``;let n=s`${t}`;return e===`Email Address`?n=s`<a href="mailto:${t}" @click=${e=>{e.preventDefault();let n=this.contact?.name?`"${this.contact.name}" <${t}>`:t;this.composeStore?.openComposer({to:[n]})}}>${t}</a>`:e===`Phone`?n=s`<a href="tel:${t}">${t}</a>`:e===`URL`&&(n=s`<a href=${t.startsWith(`http`)?t:`https://${t}`} target="_blank" rel="noopener noreferrer">${t}</a>`),s`
    ...
    `}};k([o({type:Object})],q.prototype,`contact`,void 0),k([o({type:Boolean})],q.prototype,`isEditing`,void 0),k([o({type:Boolean})],q.prototype,`saving`,void 0),k([o({type:Array})],q.prototype,`uniqueCategories`,void 0),k([o({type:Boolean})],q.prototype,`isMobile`,void 0),k([o({type:Number})],q.prototype,`selectedCount`,void 0),k([o({type:Boolean})],q.prototype,`allSelectedStarred`,void 0),k([a()],q.prototype,`scrolled`,void 0),k([g({context:w})],q.prototype,`i18nStore`,void 0),k([g({context:cn})],q.prototype,`composeStore`,void 0),k([g({context:T,subscribe:!0})],q.prototype,`settingsStore`,void 0),k([a()],q.prototype,`editForm`,void 0),k([a()],q.prototype,`isDirty`,void 0),k([a()],q.prototype,`newCategoryName`,void 0),q=k([m(`alps-contact-view`)],q);var Xn=e({});x.registerRoute({path:`/contacts/*`,component:`contacts-page`}),x.registerNavTab({id:`contacts`,pluginId:`carddav`,labelKey:`navigation.contacts`,icon:`users`,order:10}),x.registerHook(`composer:send`,async({recipients:e})=>{if(!(!e||!Array.isArray(e)))for(let t of e){let e=t,n=``,r=t.match(/^(.*?)\s*<([^>]+)>$/);r&&r[2]?(n=r[1].replace(/^["']|["']$/g,``).trim(),e=r[2]):e=e.trim();try{await P.createContact({name:n,email:e})}catch(e){console.error(`Failed to auto-save contact`,e)}}}),x.registerHook(`composer:suggest`,async({query:e})=>{try{return((await P.fetchContacts(e)).contacts||[]).map(e=>({name:e.name||``,address:e.email||``})).filter(e=>e.address)}catch(e){return console.error(`Failed to fetch contact suggestions`,e),[]}});var Zn=class extends d{constructor(...e){super(...e),this.label=``,this.description=``}static{this.styles=n`
    :host {
      display: block;
      width: 100%;
      max-width: 600px;
...
`)&&(t+=` `),h(t)}handleScroll(e){let t=e.target,n=this.shadowRoot?.querySelector(`.highlight-layer`);n&&(n.scrollTop=t.scrollTop,n.scrollLeft=t.scrollLeft)}handleInput(e){let t=e.target;this.script=t.value,this.dispatchEvent(new CustomEvent(`script-changed`,{detail:{script:this.script}}))}async validate(){this.isValidating=!0;try{await or.validateScript(this.script),window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore.t(`managesieve.toast.valid`),timeout:3e3}}))}catch(e){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:e.message||this.i18nStore.t(`managesieve.toast.networkError`),timeout:5e3,type:`error`}}))}finally{this.isValidating=!1}}async save(){this.isSaving=!0;try{await or.saveScript(this.script,`PUT`),this.initialScript=this.script,this.isDirty=!1;let e=this.script.trim()===``?`managesieve.toast.deactivated`:`managesieve.toast.saved`;window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore.t(e),timeout:3e3}}))}catch(e){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:e.message||this.i18nStore.t(`managesieve.toast.networkError`),timeout:5e3,type:`error`}}))}finally{this.isSaving=!1}}render(){return s`
		...
		`}};k([a()],sr.prototype,`isDirty`,void 0),k([g({context:w})],sr.prototype,`i18nStore`,void 0),k([o({type:String})],sr.prototype,`script`,void 0),k([a()],sr.prototype,`isValidating`,void 0),k([a()],sr.prototype,`isSaving`,void 0),sr=k([m(`alps-raw-editor`)],sr);var cr=class extends d{constructor(...e){super(...e),this.isSaving=!1,this.initialSnapshot=``,this.state={rules:[]},this.folders=[]}willUpdate(e){e.has(`state`)&&this.initialSnapshot===``&&(this.initialSnapshot=JSON.stringify(this.state))}get isDirty(){return this.initialSnapshot!==``&&this.initialSnapshot!==JSON.stringify(this.state)}markClean(){this.initialSnapshot=JSON.stringify(this.state),this.requestUpdate()}static{this.styles=n`
		.editor-container {
			display: flex;
			flex-direction: column;
			gap: 24px;
	...
	`}addRule(){this.state={...this.state,rules:[...this.state.rules,{id:Math.random().toString(36).substring(7),matchType:`all`,conditions:[{field:`Subject`,operator:`contains`,value:``}],actions:[{type:`fileinto`,value:this.folders[0]||`INBOX`}]}]},this.notifyChange()}deleteRule(e){let t=[...this.state.rules];t.splice(e,1),this.state={...this.state,rules:t},this.notifyChange()}updateRule(e,t){let n=[...this.state.rules];n[e]={...n[e],...t},this.state={...this.state,rules:n},this.notifyChange()}addCondition(e,t){let n=this.state.rules[e],r={field:`Subject`,operator:`contains`,value:``},i=[...n.conditions];t===void 0?i.push(r):i.splice(t,0,r),this.updateRule(e,{conditions:i})}deleteCondition(e,t){let n=[...this.state.rules[e].conditions];n.splice(t,1),this.updateRule(e,{conditions:n})}updateCondition(e,t,n){let r=[...this.state.rules[e].conditions],i=r[t];n.field&&n.field!==i.field&&(n.field===`Size`?i.operator!==`over`&&i.operator!==`under`&&(n.operator=`over`):(i.operator===`over`||i.operator===`under`)&&(n.operator=`contains`)),r[t]={...i,...n},this.updateRule(e,{conditions:r})}addAction(e,t){let n=this.state.rules[e],r={type:`fileinto`,value:this.folders[0]||`INBOX`},i=[...n.actions];t===void 0?i.push(r):i.splice(t,0,r),this.updateRule(e,{actions:i})}deleteAction(e,t){let n=[...this.state.rules[e].actions];n.splice(t,1),this.updateRule(e,{actions:n})}updateAction(e,t,n){let r=[...this.state.rules[e].actions];r[t]={...r[t],...n},this.updateRule(e,{actions:r})}notifyChange(){this.dispatchEvent(new CustomEvent(`state-changed`,{detail:{state:this.state}}))}save(){this.dispatchEvent(new CustomEvent(`save-requested`))}render(){return s`
		...
		`}};k([o({type:Boolean})],cr.prototype,`isSaving`,void 0),k([a()],cr.prototype,`initialSnapshot`,void 0),k([g({context:w,subscribe:!0})],cr.prototype,`i18nStore`,void 0),k([o({type:Object})],cr.prototype,`state`,void 0),k([o({type:Array})],cr.prototype,`folders`,void 0),cr=k([m(`alps-visual-editor`)],cr);var lr=class extends d{constructor(...e){super(...e),this.mode=`visual`,this.script=``,this.visualState={rules:[]},this.folders=[],this.isLoading=!0,this.isSaving=!1,this.showSwitchRawConfirm=!1}static{this.styles=n`
		.container {
			display: flex;
			flex-direction: column;
			gap: 20px;
	...
	`}connectedCallback(){super.connectedCallback(),this.fetchScript(),this.fetchFolders()}async fetchScript(){try{let e=await or.fetchScript();if(this.script=e.content||``,this.script.trim()===``)this.mode=`visual`,this.visualState={rules:[]};else{let e=ar.extractVisualState(this.script);e?(this.visualState=e,this.mode=`visual`):this.mode=`raw`}}catch(e){console.error(`Failed to fetch Sieve script`,e),this.visualState={rules:[]},this.mode=`visual`}finally{this.isLoading=!1}}async fetchFolders(){try{let e=await or.fetchFolders();e&&e.Mailboxes&&(this.folders=e.Mailboxes.map(e=>e.Name||e.Mailbox).filter(Boolean))}catch(e){console.error(`Failed to fetch folders`,e)}}handleVisualStateChange(e){this.visualState=e.detail.state}handleRawScriptChange(e){this.script=e.detail.script}switchToRaw(){this.showSwitchRawConfirm=!0}confirmSwitchToRaw(){this.script=ar.compile(this.visualState),this.mode=`raw`,this.showSwitchRawConfirm=!1}async saveVisual(){this.isSaving=!0;try{let e=ar.compile(this.visualState);this.script=e,await or.saveScript(e,`PUT`);let t=e.trim()===``?`managesieve.toast.deactivated`:`managesieve.toast.saved`;window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore.t(t),timeout:3e3}}));let n=this.shadowRoot?.querySelector(`alps-visual-editor`);n&&n.markClean&&n.markClean()}catch(e){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:e.message||this.i18nStore.t(`managesieve.toast.networkError`),timeout:5e3,type:`error`}}))}finally{this.isSaving=!1}}render(){return s`
			...
			${this.showSwitchRawConfirm?s`
				...
				></ui-confirm>
			`:``}
		`}};k([g({context:w,subscribe:!0})],lr.prototype,`i18nStore`,void 0),k([a()],lr.prototype,`mode`,void 0),k([a()],lr.prototype,`script`,void 0),k([a()],lr.prototype,`visualState`,void 0),k([a()],lr.prototype,`folders`,void 0),k([a()],lr.prototype,`isLoading`,void 0),k([a()],lr.prototype,`isSaving`,void 0),k([a()],lr.prototype,`showSwitchRawConfirm`,void 0),lr=k([m(`alps-managesieve-page`)],lr);var ur=e({});x.registerSettingsTab({id:`managesieve`,labelKey:`settings.categories.filters`,icon:`sieve`,component:`alps-managesieve-page`});var dr=class extends d{constructor(...e){super(...e),this.passwordForm={old:``,new:``,confirm:``},this.isSubmitting=!1}static{this.styles=n`
		input[type="password"] {
			width: 100%;
			box-sizing: border-box;
	...
	`}};k([g({context:w})],dr.prototype,`i18nStore`,void 0),k([a()],dr.prototype,`passwordForm`,void 0),k([a()],dr.prototype,`isSubmitting`,void 0),dr=k([m(`alps-password-settings`)],dr);var fr=e({});x.registerSettingsTab({id:`password`,labelKey:`settings.categories.password`,icon:`password`,component:`alps-password-settings`});var pr=class{constructor(e,t,n){this.routes=e,this.fallback=t,this.currentPath=this.getHashPath(),window.addEventListener(`hashchange`,()=>{this.currentPath=this.getHashPath(),n()})}getHashPath(){let e=window.location.hash;return!e||e===`#`?`/`:e.substring(1).split(`?`)[0]}navigate(e){window.location.hash=e}render(){if(this.routes[this.currentPath])return this.routes[this.currentPath]();for(let e in this.routes)if(e.endsWith(`/*`)&&this.currentPath.startsWith(e.replace(`/*`,``)))return this.routes[e]();return this.fallback()}},mr=class extends d{constructor(...e){super(...e),this.icon=``,this.title=``,this.subtitle=``}static{this.styles=n`
    :host {
      display: flex;
      justify-content: center;
      align-items: center;
  ...
  `}render(){return s`
    ...
    `}};k([o({type:String})],mr.prototype,`icon`,void 0),k([o({type:String})],mr.prototype,`title`,void 0),k([o({type:String})],mr.prototype,`subtitle`,void 0),mr=k([m(`alps-auth-card`)],mr);var Y=class extends d{constructor(...e){super(...e),this.notice=null,this.username=``,this.password=``,this.rememberMe=!1,this.error=``,this.isSubmitting=!1,this.retryAfter=0,this.isRateLimited=!1,this._handleI18nChange=()=>{this.requestUpdate()}}static{this.styles=n`
    .form-group {
      margin-bottom: 16px;
      position: relative;
    }
  ...
  `}connectedCallback(){super.connectedCallback(),this.notice=dn(),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleI18nChange)}),this.composeStore&&this.composeStore.clearAllComposers()}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleI18nChange),this.retryCountdownInterval&&clearInterval(this.retryCountdownInterval)}startRetryCountdown(e){this.retryAfter=e,this.isRateLimited=!0,this.retryCountdownInterval&&clearInterval(this.retryCountdownInterval),this.retryCountdownInterval=setInterval(()=>{this.retryAfter--,this.retryAfter<=0&&(this.isRateLimited=!1,this.retryCountdownInterval&&=(clearInterval(this.retryCountdownInterval),void 0))},1e3)}formatRetryTime(e){if(e<60)return`${e} second${e===1?``:`s`}`;let t=Math.ceil(e/60);return`${t} minute${t===1?``:`s`}`}async handleSubmit(e){if(e.preventDefault(),this.isSubmitting)return;let t=this.shadowRoot?.querySelector(`form`);if(t&&!t.checkValidity()){t.reportValidity();return}this.error=``,this.isSubmitting=!0;try{await new Promise(e=>setTimeout(e,600));let e={username:this.username,password:this.password,"remember-me":this.rememberMe?`on`:``},t=await fetch(`/session`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json();t.ok?n.requires_2fa?(window.location.hash=`/login/webauthn`,this.isSubmitting=!1):(window.dispatchEvent(new CustomEvent(`user-logged-in`)),window.location.hash=`/mailbox/-`):(t.status===429&&n.retry_after?(this.error=n.error||this.i18nStore?.t(`login.tooManyAttempts`),this.startRetryCountdown(n.retry_after)):(this.error=n.error||this.i18nStore?.t(`login.loginFailed`),this.isRateLimited=!1),this.isSubmitting=!1)}catch{this.error=this.i18nStore?.t(`login.networkError`),this.isSubmitting=!1,this.isRateLimited=!1}}render(){return s`
    ...
    `}};k([g({context:w})],Y.prototype,`i18nStore`,void 0),k([a()],Y.prototype,`notice`,void 0),k([a()],Y.prototype,`username`,void 0),k([a()],Y.prototype,`password`,void 0),k([a()],Y.prototype,`rememberMe`,void 0),k([a()],Y.prototype,`error`,void 0),k([a()],Y.prototype,`isSubmitting`,void 0),k([a()],Y.prototype,`retryAfter`,void 0),k([a()],Y.prototype,`isRateLimited`,void 0),k([g({context:cn,subscribe:!0})],Y.prototype,`composeStore`,void 0),Y=k([m(`login-page`)],Y);var hr=class extends d{constructor(...e){super(...e),this.active=!1,this.icon=``}static{this.styles=n`
    :host {
      display: flex;
      align-items: center;
      padding: 8px 16px;
  ...
  `}render(){return s`
    ...
    `}};k([o({type:Boolean,reflect:!0})],hr.prototype,`active`,void 0),k([o({type:String})],hr.prototype,`icon`,void 0),hr=k([m(`alps-category-item`)],hr);var gr=class extends d{constructor(...e){super(...e),this.newUsername=``,this.newPassword=``,this.newDisplayName=``,this.isSubmitting=!1,this.error=``,this.showAddForm=!1,this._handleStoreChange=()=>{this.requestUpdate()}}static{this.styles=n`
        :host {
            display: block;
        }
    ...
    `}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleStoreChange),this.linkedAccountsStore?.addEventListener(`change`,this._handleStoreChange),this.linkedAccountsStore&&!this.linkedAccountsStore.isInitialized()&&this.linkedAccountsStore.fetchAccounts()})}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange),this.linkedAccountsStore?.removeEventListener(`change`,this._handleStoreChange)}async handleAdd(e){if(e.preventDefault(),!(!this.newUsername||!this.newPassword)){this.isSubmitting=!0,this.error=``;try{await this.linkedAccountsStore.addAccount(this.newUsername,this.newPassword,this.newDisplayName),this.newUsername=``,this.newPassword=``,this.newDisplayName=``,this.showAddForm=!1,window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore?.t(`linkedAccounts.addedSuccess`)}}))}catch(e){this.error=e.message||this.i18nStore?.t(`linkedAccounts.addError`)}finally{this.isSubmitting=!1}}}async handleRemove(e){if(confirm(this.i18nStore?.t(`linkedAccounts.removeConfirm`)))try{await this.linkedAccountsStore.removeAccount(e),window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore?.t(`linkedAccounts.removedSuccess`)}}))}catch(e){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:e.message||this.i18nStore?.t(`linkedAccounts.removeError`)}}))}}render(){let e=this.linkedAccountsStore?.getAccounts()||[],t=this.linkedAccountsStore?.isLoading();return s`
            ...
            `:``}
        `}};k([g({context:w})],gr.prototype,`i18nStore`,void 0),k([g({context:pn})],gr.prototype,`linkedAccountsStore`,void 0),k([a()],gr.prototype,`newUsername`,void 0),k([a()],gr.prototype,`newPassword`,void 0),k([a()],gr.prototype,`newDisplayName`,void 0),k([a()],gr.prototype,`isSubmitting`,void 0),k([a()],gr.prototype,`error`,void 0),k([a()],gr.prototype,`showAddForm`,void 0),gr=k([m(`settings-accounts`)],gr);function _r(e){if(!e)throw Error(`base64url is null or undefined`);let t=e.replace(/-/g,`+`).replace(/_/g,`/`),n=atob(t),r=new Uint8Array(n.length);for(let e=0;e<n.length;e++)r[e]=n.charCodeAt(e);return r.buffer}function vr(e){let t=new Uint8Array(e),n=``;for(let e=0;e<t.byteLength;e++)n+=String.fromCharCode(t[e]);return btoa(n).replace(/\+/g,`-`).replace(/\//g,`_`).replace(/=/g,``)}async function yr(e){e.publicKey.challenge=_r(e.publicKey.challenge),e.publicKey.user.id=_r(e.publicKey.user.id),e.publicKey.excludeCredentials&&(e.publicKey.excludeCredentials=e.publicKey.excludeCredentials.map(e=>({...e,id:_r(e.id)})));let t=await navigator.credentials.create(e);if(!t)throw Error(`Credential creation failed or was cancelled.`);let n=t.response,r=n.getTransports?n.getTransports():[];return{id:t.id,rawId:vr(t.rawId),type:t.type,response:{attestationObject:vr(n.attestationObject),clientDataJSON:vr(n.clientDataJSON)},transports:r}}async function br(e){e.publicKey.challenge=_r(e.publicKey.challenge),e.publicKey.allowCredentials&&(e.publicKey.allowCredentials=e.publicKey.allowCredentials.map(e=>({...e,id:_r(e.id)})));let t=await navigator.credentials.get(e);if(!t)throw Error(`Assertion failed or was cancelled.`);let n=t.response;return{id:t.id,rawId:vr(t.rawId),type:t.type,response:{authenticatorData:vr(n.authenticatorData),clientDataJSON:vr(n.clientDataJSON),signature:vr(n.signature),userHandle:n.userHandle?vr(n.userHandle):null}}}function xr(){return window.PublicKeyCredential!==void 0&&navigator.credentials!==void 0}var Sr=class extends d{constructor(...e){super(...e),this.data=null,this.error=``,this.loading=!0,this.adding=!1,this.showNamePrompt=!1,this.pendingCredential=null,this.pendingDeleteId=null}static{this.styles=n`
        :host { display: block; }
        .setting-row {
            display: flex;
            justify-content: space-between;
    ...
    `}connectedCallback(){super.connectedCallback(),this.fetchData()}async fetchData(){try{this.loading=!0;let e=await fetch(`/settings/2fa`);if(!e.ok)throw Error(`Failed to fetch settings`);this.data=await e.json()}catch(e){this.error=e.message}finally{this.loading=!1}}async handleTrustToggle(e){let t=e.target;await fetch(`/settings/2fa/trust-linked-accounts`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({trust:t.checked})}),this.fetchData()}async addCredential(){this.adding=!0,this.error=``;try{let e=await fetch(`/settings/2fa/begin`,{method:`POST`});if(!e.ok)throw Error(await e.text());let t=await yr(await e.json());this.pendingCredential=t,this.showNamePrompt=!0,this.adding=!1}catch(e){e.name===`NotAllowedError`||e.message&&e.message.includes(`not allowed`)?this.error=``:this.error=this.i18nStore?.t(`webauthn.errors.register_failed`)||`There was an error registering your security key. Please try again.`,this.adding=!1}}async _handlePromptSubmit(e){let t=e.detail.keyName||`Security Key`;this.showNamePrompt=!1;let n={...this.pendingCredential,name:t};this.adding=!0,this.error=``;try{let e=await fetch(`/settings/2fa/finish`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(n)});if(!e.ok)throw Error(await e.text());this.fetchData()}catch{this.error=this.i18nStore?.t(`webauthn.errors.register_failed`)||`There was an error registering your security key. Please try again.`}finally{this.adding=!1,this.pendingCredential=null}}_handlePromptCancel(){this.showNamePrompt=!1,this.pendingCredential=null}removeCredential(e){this.pendingDeleteId=e}async executeRemoveCredential(){if(!this.pendingDeleteId)return;let e=this.pendingDeleteId;this.pendingDeleteId=null;try{this.error=``;let t=await fetch(`/settings/2fa/credential/${encodeURIComponent(e)}/delete`,{method:`POST`});if(!t.ok)throw Error(await t.text());this.fetchData()}catch(e){this.error=e.message||this.i18nStore?.t(`webauthn.errors.remove_failed`)}}render(){return this.loading?s`<div>Loading...</div>`:s`
            ...
            `:``}
        `}};k([g({context:w})],Sr.prototype,`i18nStore`,void 0),k([a()],Sr.prototype,`data`,void 0),k([a()],Sr.prototype,`error`,void 0),k([a()],Sr.prototype,`loading`,void 0),k([a()],Sr.prototype,`adding`,void 0),k([a()],Sr.prototype,`showNamePrompt`,void 0),k([a()],Sr.prototype,`pendingCredential`,void 0),k([a()],Sr.prototype,`pendingDeleteId`,void 0),Sr=k([m(`alps-webauthn-settings`)],Sr);var X=class extends d{constructor(...e){super(...e),this.category=`general`,this.isMobile=window.innerWidth<=768,this.mobileSidebarOpen=!1,this.username=``,this.isScrolled=!1,this.sidebarWidth=250,this.sidebarCollapsed=!1,this.isSidebarDragging=!1,this.isSidebarHovered=!1,this.hoverTimeout=null,this.suppressSidebarHover=!1,this._handleResize=()=>{this.isMobile=window.innerWidth<=768,this.isMobile||(this.mobileSidebarOpen=!1)},this._handleScroll=e=>{let t=e.target;this.isScrolled=t.scrollTop>0},this._handleSettingsChange=()=>{this._syncState()},this._handleI18nChange=()=>{this.requestUpdate()}}static{this.styles=[st,n`
    :host {
      display: flex;
      flex-direction: column;
      height: 100vh;
      ...
      <div class="app-container ${this.sidebarCollapsed&&!this.isMobile?`collapsed`:``} ${this.isSidebarDragging?`dragging`:``}" style="${!this.sidebarCollapsed&&!this.isMobile?`--sidebar-width: ${this.sidebarWidth}px;`:``}">
        ...
        <div class="main-view" @scroll=${this._handleScroll}>
          ${this.settingsState?s`
            ...
            ${x.getSettingsTabs().filter(e=>e.id===this.category).map(e=>s`${h(`<${e.component}></${e.component}>`)}`)}
  ...
  `}connectedCallback(){super.connectedCallback(),this.extractParams(),this.mailbox&&this.uid?this.fetchOriginal():(this.error=this.i18nStore?.t(`originalMessage.errorMissingParams`),this.loading=!1),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleStoreChange)})}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange)}extractParams(){let e=window.location.hash,t=e.indexOf(`?`);if(t!==-1){let n=new URLSearchParams(e.substring(t+1));this.mailbox=n.get(`mailbox`)||``,this.uid=n.get(`uid`)||``}}async fetchOriginal(){try{this.loading=!0;let e=await E(`/mailboxes/${D(this.mailbox)}/messages/${this.uid}/raw?limit=${this.MAX_DISPLAY_SIZE}`);if(!e.ok){if(e.status===401){window.location.hash=`#/login`;return}throw Error(this.i18nStore?.t(`originalMessage.errorFailedToFetch`))}this.rawText=await e.text(),this.rawText.length>=this.MAX_DISPLAY_SIZE&&(this.isTruncated=!0),this.parsedHeaders=await Cr(this.rawText)}catch(e){this.error=e.message}finally{this.loading=!1}}copyToClipboard(){navigator.clipboard.writeText(this.rawText).then(()=>{alert(this.isTruncated?this.i18nStore?.t(`originalMessage.copiedTruncated`):this.i18nStore?.t(`originalMessage.copied`))}).catch(e=>{S.error(`Failed to copy: `,e),alert(this.i18nStore?.t(`originalMessage.copyFailed`))})}renderAuthStatus(e,t){e=e.toLowerCase();let n=s`<span class="auth-none">${this.i18nStore?.t(`originalMessage.none`)}</span>`;return e===`pass`?n=s`<span class="auth-pass">${this.i18nStore?.t(`originalMessage.pass`)}</span>`:e===`fail`&&(n=s`<span class="auth-fail">${this.i18nStore?.t(`originalMessage.fail`)}</span>`),s`
    ...
    `}};k([a()],wr.prototype,`rawText`,void 0),k([a()],wr.prototype,`parsedHeaders`,void 0),k([a()],wr.prototype,`loading`,void 0),k([a()],wr.prototype,`error`,void 0),k([a()],wr.prototype,`mailbox`,void 0),k([a()],wr.prototype,`uid`,void 0),k([a()],wr.prototype,`isTruncated`,void 0),k([g({context:w})],wr.prototype,`i18nStore`,void 0),wr=k([m(`original-message-page`)],wr);var Z=class extends d{constructor(...e){super(...e),this.loading=!0,this.error=``,this.mailbox=``,this.uid=``,this.message=null,this.content=``,this.rawMessageHtml=``,this.mimeType=`text/plain`,this.hasRemoteResources=!1,this.allowRemoteResources=!1,this.printTriggered=!1}static{this.styles=n`
    :host {
      display: block;
      min-height: 100vh;
      background: #fff;
  ...
  `}connectedCallback(){super.connectedCallback(),this.allowRemoteResources=this.settingsStore.getState().showRemoteContent===`always`,this.extractParams(),this.mailbox&&this.uid?this.fetchMessage():(this.error=`Missing mailbox or uid parameters`,this.loading=!1)}extractParams(){let e=window.location.hash,t=e.indexOf(`?`);if(t!==-1){let n=new URLSearchParams(e.substring(t+1));this.mailbox=n.get(`mailbox`)||``,this.uid=n.get(`uid`)||``,n.get(`remote`)===`1`&&(this.allowRemoteResources=!0)}}async fetchMessage(){try{this.loading=!0;let e=Rt.get(this.mailbox,this.uid);if(e&&e.Part){this.message=e.Message,this.mimeType=e.Part.MIMEType||e.Part.MimeType||`text/plain`,e.RawHtml===void 0?e.RawText!==void 0&&(this.content=e.RawText):(this.rawMessageHtml=e.RawHtml,this.hasRemoteResources=!1,this.content=jn(this.rawMessageHtml,{mailbox:this.mailbox,messageUid:this.uid,allowRemoteResources:this.allowRemoteResources,messageStructure:this.message.BodyStructure,onRemoteResourceBlocked:()=>{this.hasRemoteResources=!0}})),this.loading=!1;return}let t=await E(`/mailboxes/${D(this.mailbox)}/messages/${this.uid}`);if(!t.ok){if(t.status===401){window.location.hash=`#/login`;return}throw Error(`Failed to fetch message metadata`)}this.message=await t.json(),await this.fetchMessageBody()}catch(e){this.error=e.message}finally{this.loading=!1}}findDisplayPart(e,t){if(!e)return null;if(e.MIMEType&&e.MIMEType.toLowerCase().startsWith(`multipart/`)){if(e.MIMEType.toLowerCase()===`multipart/alternative`){let n=null,r=null;for(let t of e.Children||[])t.MIMEType?.toLowerCase()===`text/plain`&&(n=t),t.MIMEType?.toLowerCase()===`text/html`&&(r=t);return t===`html`?r||n||e.Children[0]:n||r||e.Children[0]}for(let n of e.Children||[]){let e=this.findDisplayPart(n,t);if(e)return e}}return e.MIMEType?.toLowerCase()===`text/html`||e.MIMEType?.toLowerCase()===`text/plain`?e:null}findPartPath(e,t,n=``){if(!e)return null;if(e===t)return n||`1`;if(e.Children&&Array.isArray(e.Children))for(let r=0;r<e.Children.length;r++){let i=n?`${n}.${r+1}`:`${r+1}`,a=this.findPartPath(e.Children[r],t,i);if(a)return a}return null}async fetchMessageBody(){if(!this.message||!this.message.BodyStructure)return;let e=`1`,t=this.findDisplayPart(this.message.BodyStructure,`html`);if(t?(e=this.findPartPath(this.message.BodyStructure,t)||`1`,this.mimeType=t.MIMEType||`text/plain`):(this.mimeType=this.message.BodyStructure.MIMEType||`text/plain`,this.mimeType.toLowerCase()===`text/plain`||this.mimeType.toLowerCase()===`text/html`?e=`1`:this.mimeType=`multipart/mixed`),this.mimeType.toLowerCase().startsWith(`multipart/`)){this.content=``;return}let n=await E(`/mailboxes/${D(this.mailbox)}/messages/${this.uid}/raw?part=${e}`);if(!n.ok)throw Error(`Failed to fetch message body`);this.mimeType.toLowerCase()===`text/html`?(this.rawMessageHtml=await n.text(),this.hasRemoteResources=!1,this.content=jn(this.rawMessageHtml,{mailbox:this.mailbox,messageUid:this.uid,allowRemoteResources:this.allowRemoteResources,messageStructure:this.message.BodyStructure,onRemoteResourceBlocked:()=>{this.hasRemoteResources=!0}})):this.content=await n.text()}loadRemoteResources(){this.allowRemoteResources=!0,this.printTriggered=!1,this.rawMessageHtml&&(this.content=jn(this.rawMessageHtml,{mailbox:this.mailbox,messageUid:this.uid,allowRemoteResources:this.allowRemoteResources,messageStructure:this.message?.BodyStructure,onRemoteResourceBlocked:()=>{this.hasRemoteResources=!0}}))}updated(e){e.has(`content`)&&this.content&&this.mimeType?.toLowerCase()!==`text/html`&&setTimeout(()=>{window.print()},500)}onPrintIframeLoad(e){let t=e.target;try{let e=t.contentDocument;e&&e.body&&(t.style.height=`${e.body.scrollHeight}px`)}catch{}this.printTriggered||(this.printTriggered=!0,setTimeout(()=>window.print(),300))}render(){if(this.loading)return s`
    ...
    `}};k([g({context:T})],Z.prototype,`settingsStore`,void 0),k([g({context:w})],Z.prototype,`i18nStore`,void 0),k([a()],Z.prototype,`loading`,void 0),k([a()],Z.prototype,`error`,void 0),k([a()],Z.prototype,`mailbox`,void 0),k([a()],Z.prototype,`uid`,void 0),k([a()],Z.prototype,`message`,void 0),k([a()],Z.prototype,`content`,void 0),k([a()],Z.prototype,`rawMessageHtml`,void 0),k([a()],Z.prototype,`mimeType`,void 0),k([a()],Z.prototype,`hasRemoteResources`,void 0),k([a()],Z.prototype,`allowRemoteResources`,void 0),Z=k([m(`print-page`)],Z);var Tr=class extends d{constructor(...e){super(...e),this.statusMessage=``,this.statusType=`info`,this.isLoading=!1,this.isSuccess=!1,this._handleI18nChange=()=>{this.requestUpdate()}}static{this.styles=n`
    .status {
      margin-bottom: 24px;
      padding: 8px 12px;
      border-radius: var(--radius-md, 6px);
...
`).map(e=>`<p>${e}</p>`).join(``):this.text),onUpdate:({editor:e})=>{this.format===`html`&&(this.htmlText=e.getHTML(),this.text=e.getText(),this.dispatchEvent(new CustomEvent(`text-changed`,{detail:{text:this.text,html:this.htmlText},bubbles:!0,composed:!0})))},onTransaction:({editor:e})=>{!e.isActive(`link`)&&this.bubbleMenuState===`edit`&&(this.bubbleMenuState=`view`),this.requestUpdate()}}),this.editor.setEditable(!this.isSending),this.requestUpdate())}clear(){this.replyInputRef.value&&(this.replyInputRef.value.value=``),this.text=``,this.htmlText=``,this.editor&&!this.editor.isDestroyed&&this.editor.commands.clearContent(),this.attachments=[],this.dispatchEvent(new CustomEvent(`text-changed`,{detail:{text:``,html:``},bubbles:!0,composed:!0}))}insertFormatting(e,t=``){if(this.format===`html`&&this.editor&&!this.editor.isDestroyed){e===`**`?this.editor.chain().focus().toggleBold().run():e===`*`&&this.editor.chain().focus().toggleItalic().run();return}let n=this.replyInputRef.value;if(!n)return;let r=n.selectionStart,i=n.selectionEnd,a=n.value,o=a.substring(r,i);if(o.startsWith(e)&&o.endsWith(t)&&o.length>=e.length+t.length){let a=o.substring(e.length,o.length-t.length);n.setRangeText(a,r,i,`select`)}else r>=e.length&&a.substring(r-e.length,r)===e&&i+t.length<=a.length&&a.substring(i,i+t.length)===t?n.setRangeText(o,r-e.length,i+t.length,`select`):(n.setRangeText(e+o+t,r,i,`select`),r===i&&(n.selectionStart=r+e.length,n.selectionEnd=r+e.length));this.text=n.value,this.editor&&!this.editor.isDestroyed&&(this.htmlText=this.editor.getHTML()),this.dispatchEvent(new CustomEvent(`text-changed`,{detail:{text:this.text,html:this.htmlText},bubbles:!0,composed:!0})),n.focus()}insertEmoji(e){if(this.format===`html`&&this.editor&&!this.editor.isDestroyed)this.editor.chain().focus().insertContent(e).run();else{let t=this.replyInputRef.value;if(!t)return;let n=t.selectionStart,r=t.selectionEnd;t.setRangeText(e,n,r,`end`),this.text=t.value,this.editor&&!this.editor.isDestroyed&&(this.htmlText=this.editor.getHTML()),this.dispatchEvent(new CustomEvent(`text-changed`,{detail:{text:this.text,html:this.htmlText},bubbles:!0,composed:!0})),t.focus()}}_handleInput(e){this.text=e.target.value,this.dispatchEvent(new CustomEvent(`text-changed`,{detail:{text:this.text,html:this.htmlText},bubbles:!0,composed:!0}))}static{this.styles=[gt,n`
  ...
  `}render(){if(this.instance.closing)return s`<style>:host { display: none !important; }</style>`;let e=((this.instance.to?.length||0)>0||(this.instance.cc?.length||0)>0||(this.instance.bcc?.length||0)>0)&&(this.instance.text?.trim().length||0)>0,t,n;if(this.instance.minimized)t=24,n=24+this.minimizedIndex*40;else{let e=this.totalMinimized>0?276:0;if(t=24+e+this.openIndex*486,n=0,24+e+this.totalOpen*470>this.windowWidth&&this.totalOpen>1){let n=this.windowWidth-470-48-e,r=n>0?n/(this.totalOpen-1):32;t=24+e+this.openIndex*Math.min(r,470)}}let r,i,a,o,c=this.windowWidth<=768;return this.showDiscardConfirm?(this.style.zIndex=`30000`,c?(a=this.windowWidth,o=this.windowHeight,i=0,r=0,this.removeAttribute(`expanded`)):this.instance.expanded?(a=Math.min(this.windowWidth*.85,800),o=this.windowHeight*.8,i=(this.windowWidth-a)/2,r=(this.windowHeight-o)/2,this.setAttribute(`expanded`,``)):(a=this.instance.minimized?260:470,o=this.instance.minimized?40:500,i=this.windowWidth-t-a,r=this.windowHeight-n-o,this.removeAttribute(`expanded`))):c?(a=this.windowWidth,o=this.windowHeight,i=0,r=0,this.style.zIndex=`30000`,this.removeAttribute(`expanded`)):this.instance.expanded?(a=Math.min(this.windowWidth*.85,800),o=this.windowHeight*.8,i=(this.windowWidth-a)/2,r=(this.windowHeight-o)/2,this.style.zIndex=`30000`,this.setAttribute(`expanded`,``)):(a=this.instance.minimized?260:470,o=this.instance.minimized?40:500,i=this.windowWidth-t-a,r=this.windowHeight-n-o,this.style.zIndex=`${this.instance.zIndex||1e3}`,this.removeAttribute(`expanded`)),c?(this.style.width=`100%`,this.style.height=`100dvh`,this.style.left=`0`,this.style.top=`0`):(this.style.width=`${a}px`,this.style.height=`${o}px`,this.style.left=`${i}px`,this.style.top=`${r}px`),this.instance.minimized?this.setAttribute(`minimized`,``):this.removeAttribute(`minimized`),s`
        ...
        <div class="content">
          ...
          <div class="send-row">
            <div class="toolbar-actions">
              ...
              ${x.invokeHook(`composer:toolbar`,{composer:this,instance:this.instance})?.filter(Boolean)}
    ...
    `}};k([g({context:cn})],$.prototype,`composeStore`,void 0),k([g({context:w})],$.prototype,`i18nStore`,void 0),k([g({context:T})],$.prototype,`settingsStore`,void 0),k([o({type:Object})],$.prototype,`instance`,void 0),k([o({type:Number})],$.prototype,`index`,void 0),k([o({type:Number})],$.prototype,`totalOpen`,void 0),k([o({type:Number})],$.prototype,`totalMinimized`,void 0),k([o({type:Number})],$.prototype,`openIndex`,void 0),k([o({type:Number})],$.prototype,`minimizedIndex`,void 0),k([a()],$.prototype,`showCc`,void 0),k([a()],$.prototype,`showBcc`,void 0),k([a()],$.prototype,`showDiscardConfirm`,void 0),k([a()],$.prototype,`pendingDiscardType`,void 0),k([a()],$.prototype,`windowWidth`,void 0),k([a()],$.prototype,`windowHeight`,void 0),k([a()],$.prototype,`isSaving`,void 0),k([a()],$.prototype,`isDragOver`,void 0),k([a()],$.prototype,`linkPromptFields`,void 0),$=k([m(`alps-floating-composer`)],$);var Ir=class extends d{constructor(...e){super(...e),this.show=!1,this.message=``,this.actionLabel=``,this.timeout=0,this._timer=null}updated(e){e.has(`show`)&&(this.show&&this.timeout>0?(this._timer&&clearTimeout(this._timer),this._timer=setTimeout(()=>{this.dismiss()},this.timeout)):!this.show&&this._timer&&(clearTimeout(this._timer),this._timer=null))}dismiss(){this.onDismiss&&this.onDismiss(),this.close()}close(){this.show=!1,this.dispatchEvent(new CustomEvent(`dismiss`)),this.onAction=void 0,this.onDismiss=void 0}handleAction(){this.onAction?this.onAction():this.dispatchEvent(new CustomEvent(`action`)),this.close()}static{this.styles=n`
    :host {
      display: block;
  ...
  `}connectedCallback(){super.connectedCallback();let e=document.cookie.split(`;`).some(e=>e.trim().startsWith(`alps_logged_in=1`))||document.cookie.split(`;`).some(e=>e.trim().startsWith(`alps_has_login_token=1`));!e&&!window.location.hash.startsWith(`#/login`)&&(window.location.hash=`#/login`),this.composeStore.addEventListener(`change`,this._handleComposeChange),this.settingsStore.addEventListener(`change`,this._handleSettingsChange),this.activeComposers=this.composeStore.getState().activeComposers;let t=this.settingsStore.getState().autoLogout??0;Lr.setLogoutTime(t),Lr.onBeforeLogout=async()=>{await this.composeStore.saveAllDirtyDrafts()};let n=this.settingsStore.getState().language??`en`;this.i18nStore.setLanguage(n),window.addEventListener(`auth-error`,this._handleAuthError),window.addEventListener(`show-toast`,this._handleShowToast),window.addEventListener(`beforeunload`,this._handleBeforeUnload),window.addEventListener(`online`,this._handleOnlineEvent),window.addEventListener(`offline`,this._handleOfflineEvent),window.addEventListener(`network-error`,this._handleNetworkError),window.addEventListener(`dragover`,this._handleGlobalDragOver),window.addEventListener(`drop`,this._handleGlobalDrop),window.addEventListener(`plugins-updated`,this._handlePluginsUpdated),this.isOffline&&this._handleOfflineEvent(),e&&this._fetchSessionData()}async _fetchSessionData(){try{let e=await fetch(`/session`);if(e.ok){let t=await e.json();t.EnabledPlugins&&x.setEnabledPlugins(t.EnabledPlugins)}}catch(e){console.error(`Failed to fetch session data`,e)}}disconnectedCallback(){super.disconnectedCallback(),this.composeStore.removeEventListener(`change`,this._handleComposeChange),this.settingsStore.removeEventListener(`change`,this._handleSettingsChange),window.removeEventListener(`auth-error`,this._handleAuthError),window.removeEventListener(`show-toast`,this._handleShowToast),window.removeEventListener(`beforeunload`,this._handleBeforeUnload),window.removeEventListener(`online`,this._handleOnlineEvent),window.removeEventListener(`offline`,this._handleOfflineEvent),window.removeEventListener(`network-error`,this._handleNetworkError),window.removeEventListener(`dragover`,this._handleGlobalDragOver),window.removeEventListener(`drop`,this._handleGlobalDrop),window.removeEventListener(`plugins-updated`,this._handlePluginsUpdated),this._stopOfflineCountdown()}_startOfflineCountdown(){this._stopOfflineCountdown(),this.offlineInterval=window.setInterval(async()=>{if(this.offlineCountdown>1)this.offlineCountdown--;else{if(this.offlineCountdown=10,this._isPinging)return;this._isPinging=!0;try{await this._verifyConnectivity()&&(this.isOffline=!1,this._stopOfflineCountdown())}finally{this._isPinging=!1}}},1e3)}_stopOfflineCountdown(){this.offlineInterval!==null&&(clearInterval(this.offlineInterval),this.offlineInterval=null)}_handleDismissToast(e){this.toasts=this.toasts.map(t=>t.id===e?{...t,show:!1}:t),setTimeout(()=>{this.toasts=this.toasts.filter(t=>t.id!==e)},300)}getRoutes(){let e={"/":()=>this.mailboxPageTemplate,"/login":()=>s`<login-page></login-page>`,"/mailbox/*":()=>this.mailboxPageTemplate,"/settings":()=>s`<settings-page category="general"></settings-page>`,"/settings/*":()=>{let e=window.location.hash.match(/^#\/settings\/?(.*)$/);return s`<settings-page .category=${e&&e[1]?e[1].split(`?`)[0]:`general`}></settings-page>`},"/original":()=>s`<original-message-page></original-message-page>`,"/print":()=>s`<print-page></print-page>`,"/login/webauthn":()=>s`<login-webauthn-page></login-webauthn-page>`};return x.getRoutes().forEach(t=>{let n=null;e[t.path]=()=>(n||=document.createElement(t.component),n)}),e}render(){let e=this.activeComposers.filter(e=>!e.minimized).length,t=this.activeComposers.filter(e=>e.minimized).length,n=0,r=0;return s`
      ...
      `:``}
    `}};k([i({context:cn})],zr.prototype,`composeStore`,void 0),k([i({context:T})],zr.prototype,`settingsStore`,void 0),k([i({context:w})],zr.prototype,`i18nStore`,void 0),k([i({context:pn})],zr.prototype,`linkedAccountsStore`,void 0),k([a()],zr.prototype,`activeComposers`,void 0),k([a()],zr.prototype,`toasts`,void 0),k([a()],zr.prototype,`isOffline`,void 0),k([a()],zr.prototype,`offlineCountdown`,void 0),zr=k([m(`app-root`)],zr);var Br=Object.assign({"../../plugins/caldav/frontend/index.ts":Nt,"../../plugins/carddav/frontend/index.ts":Xn,"../../plugins/gpg/frontend/index.ts":ir,"../../plugins/managesieve/frontend/index.ts":ur,"../../plugins/password/frontend/index.ts":fr});S.info(`Loaded ${Object.keys(Br).length} frontend plugins.`);